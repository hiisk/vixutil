    ...
    <div className="page-wrap">
      ...
      <header className="page-head">
        <div className="page-bar">
          ...
          <span className="row-name">{c.area}㎡ {ui.useName(c.use)}</span>
      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="sec-h2-tight">{ui.wattTitle}</h2>
        ...
        <section className="mb-8">
          <h2 className="sec-h2-tight">{ui.spreadTitle}</h2>
          <p className="note-xs">{ui.spreadNote}</p>
        </section>
        ...
        <nav className="foot-nav" aria-label="Language">
          {LANGS.filter(l => l.lang !== lang).map(l => (
            <Link prefetch={false} key={l.lang} href={`${l.prefix}/lumen/${slug}`} hrefLang={l.hreflang} className="dim-link">
              {l.label}
            </Link>
          ))}
        </nav>
