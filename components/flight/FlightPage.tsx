    ...
    <div className="relative min-h-screen bg-white dark:bg-slate-900">
      ...
      <header className="page-head">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 truncate">{pair}</span>
      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="mt-2 text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.arriveNote}</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.greatCircleNote}</p>
        </section>

        <section className="mb-8">
          <h2 className="sec-h2-tight">{ui.dstTitle}</h2>
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.dstNote}</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.centerNote}</p>
        </section>
