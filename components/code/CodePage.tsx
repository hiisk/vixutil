    ...
    <div className="relative min-h-screen bg-white dark:bg-slate-900">
      ...
      <header className="bg-white/90 dark:bg-slate-900/90 backdrop-blur border-b border-slate-100 dark:border-slate-800 sticky top-0 z-20">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 truncate">{crumb}</span>
      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        {f && (
          <section className="mb-8">
            <h2 className="text-base font-black text-slate-800 dark:text-slate-100 mb-1">{ui.morseTitle}</h2>
        ...
        {f?.nato && (
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed mb-8">{ui.natoNote}</p>
        )}
        ...
        {cell && (
          <section className="mb-8">
            <h2 className="text-base font-black text-slate-800 dark:text-slate-100 mb-3">{ui.raisedGroup(cell.raised)}</h2>
            <div className="flex flex-wrap gap-2">
