          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {related.map(r => (
              <Link
                ...
                className="group hub-card hover:border-emerald-300 hover:shadow-sm transition-all"
              >
                <ToolIcon emoji={r.icon} color={r.og[0]} accent={r.og[1]} className="w-5 h-5 shrink-0" />
                <span className="hub-card-body">
                  <span className="hub-card-title group-hover:text-emerald-700 transition-colors">
                    {r.title}
                  </span>
