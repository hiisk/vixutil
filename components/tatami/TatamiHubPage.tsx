    ...
    <div className="relative min-h-screen bg-white dark:bg-slate-900">
      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-base font-black text-slate-800 dark:text-slate-100 mb-3">6 · {ui.sqmLabel}</h2>
        ...
        <section className="mb-4 mt-8">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.sqmLabel}</p>
        </section>
