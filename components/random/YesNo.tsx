  ...
  return (
    <div>
      ...
      <button
        onClick={go}
        disabled={spinning}
        className="w-full mt-5 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-black text-lg rounded-2xl py-4 shadow-lg shadow-rose-200 dark:shadow-none hover:-translate-y-0.5 hover:shadow-xl transition-all disabled:opacity-60"
      >
        {ui.decide} 🪙
      </button>
