            ...
            return (
              <section key={group.name}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/30 px-2.5 py-0.5 rounded-full">{group.items.length}</span>
                </div>
