    ...
    <div className="page-wrap">
      ...
      <header className="page-head">
        <div className="page-bar">
          ...
          <span className="row-name tabular-nums">{ui.bedName(c.bed)} · {c.room}</span>
      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="mt-2 note-xs">{ui.nameNote}</p>
        </section>

        <section className="mb-8">
          <h2 className="sec-h2-tight">{ui.walkTitle}</h2>
          <p className="note-xs">{ui.walkNote}</p>
        </section>

        <section className="mb-8">
          <h2 className="sec-h2-tight">{ui.personTitle}</h2>
          <p className="note-xs">{ui.personNote}</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="note-xs">{ui.ksNote}</p>
        </section>
        ...
        <nav className="foot-nav" aria-label="Language">
          {LANGS.filter(l => l.lang !== lang).map(l => (
            <Link prefetch={false} key={l.lang} href={`${l.prefix}/bed/${slug}`} hrefLang={l.hreflang} className="dim-link">
              {l.label}
            </Link>
          ))}
        </nav>
