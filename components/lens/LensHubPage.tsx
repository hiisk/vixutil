      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        {SENSORS.map(s => (
          <section key={s.key} className="mb-9">
            <h2 className="text-base font-black text-slate-800 dark:text-slate-100 mb-1">{s.name}</h2>
        ...
        <section className="mt-8">
          <h2 className="text-base font-black text-slate-800 dark:text-slate-100 mb-3">{ui.kindTitle}</h2>
