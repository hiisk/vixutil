...
import { TOPIC_SLUGS, TOPIC_EMOJI, type TopicSlug } from '@/lib/saju-topics';
...
export default function SajuTopicNav({ lang, current, query = '' }: {
  ...
  return (
    <nav aria-label={c.ui.otherTopics}>
      <p className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-3">
        {c.ui.otherTopics}
      </p>
