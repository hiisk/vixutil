    ...
    <div className="page-wrap">
      ...
      <header className="page-head">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-2">
          <Link prefetch={false} href={homeHref} className={`flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400 ${section.linkHover} transition-colors font-medium`}>
      ...
      <main className="relative max-w-3xl mx-auto px-4 py-9">
        ...
        <p className="text-center text-xs text-slate-500 dark:text-slate-400 mt-4 leading-relaxed">{meta.footNote}</p>
      </main>
