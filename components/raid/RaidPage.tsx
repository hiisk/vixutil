      ...
      <main className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        {f.possible && (
          <section className="mb-8">
            ...
            <p className="mt-2 text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.sizeNote}</p>
          </section>
        )}
        ...
        {f.others.length > 0 && (
          <section className="mb-8">
            ...
            <p className="mt-2 text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.splitNote}</p>
          </section>
        )}
        ...
        <section className="mb-8">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.rebuildNote}</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">{ui.backupNote}</p>
        </section>
        ...
        <nav className="foot-nav" aria-label="Language">
          {LANGS.filter(l => l.lang !== lang).map(l => (
            <Link key={l.lang} href={`${l.prefix}/raid/${slug}`} hrefLang={l.hreflang} className="hover:text-slate-700 dark:hover:text-slate-300 transition-colors">
              {l.label}
            </Link>
          ))}
        </nav>
