...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '다운로드 336칸 — 100Mbps로 1GB는 85초',
    '336 download times — 1 GB over 100 Mbps takes 85 seconds',
    '336 tiempos de descarga — 1 GB a 100 Mbps tarda 85 segundos',
    '336 tempos de download — 1 GB a 100 Mbps leva 85 segundos',
    'ダウンロード240マス — 100Mbpsで1GBは85秒',
    '336 Downloadzeiten — 1 GB über 100 Mbit/s dauert 85 Sekunden',
    '336 temps de téléchargement — 1 Go à 100 Mb/s prend 85 secondes',
    '240 डाउनलोड समय — 100 Mbps पर 1 GB में 85 सेकंड',
    '336 个下载时间 — 100Mbps 下载 1GB 需 85 秒',
    '336 個下載時間 — 100Mbps 下載 1GB 需 85 秒',
  ),

  hubLead: T(
    '파일 크기 24가지와 회선 속도 14가지가 만나는 칸마다 걸리는 시간을 계산했습니다. 광고하는 속도를 8로 나눈 뒤, 거기서 다시 6%가 주소와 순번으로 빠집니다.',
    'A time for every meeting of 24 file sizes and 14 line speeds. Divide the advertised number by eight, then lose another 6% to addresses and sequence numbers.',
    'Un tiempo para cada cruce de 24 tamaños de archivo y 14 velocidades. Divide el número anunciado entre ocho y pierde otro 6% en direcciones y números de secuencia.',
    'Um tempo para cada cruzamento de 24 tamanhos de arquivo e 14 velocidades. Divida o número anunciado por oito e perca mais 6% em endereços e números de sequência.',
    'ファイルサイズ24通りと回線速度10通りが出会う各マスの所要時間を計算しました。広告の数字を8で割り、そこからさらに6%が宛先と順番に取られます。',
    'Eine Zeit für jede Begegnung von 24 Dateigrößen und 14 Leitungsgeschwindigkeiten. Teile die beworbene Zahl durch acht, dann gehen weitere 6 % für Adressen und Sequenznummern ab.',
    'Un temps pour chaque croisement de 24 tailles de fichier et 14 débits. Divisez le chiffre annoncé par huit, puis perdez encore 6 % en adresses et numéros de séquence.',
    ...
    '24 种文件大小与 14 种线路速度交汇的每一格都算出所需时间。把广告数字除以八，再有 6% 被地址和序号占去。',
    '24 種檔案大小與 14 種線路速度交匯的每一格都算出所需時間。把廣告數字除以八，再有 6% 被位址和序號佔去。',
  ),
  ...
  hubMetaTitle: T(
    '다운로드 시간 계산 — 파일 크기 24가지 × 회선 속도 14가지',
    'Download time calculator — 24 file sizes across 14 line speeds',
    'Calculadora de tiempo de descarga — 24 tamaños y 14 velocidades',
    'Calculadora de tempo de download — 24 tamanhos e 14 velocidades',
    'ダウンロード時間の計算 — サイズ24通り×回線10通り',
    'Downloadzeit berechnen — 24 Dateigrößen und 14 Geschwindigkeiten',
    'Calcul du temps de téléchargement — 24 tailles et 14 débits',
    'डाउनलोड समय कैलकुलेटर — 24 आकार और 10 गति',
    '下载时间计算 — 24 种大小 × 14 种线路速度',
    '下載時間計算 — 24 種大小 × 14 種線路速度',
  ),

  hubMetaDesc: T(
    '100Mbps로 1GB는 85초. 파일 크기와 회선 속도가 만나는 336칸마다 걸리는 시간, 실제 MB/s, 어디가 병목인지까지 계산했습니다.',
    '1 GB over 100 Mbps takes 85 seconds. For all 336 pairings of file size and line speed: the time, the real MB/s, and which hop is the bottleneck.',
    '1 GB a 100 Mbps tarda 85 segundos. Para los 336 cruces de tamaño y velocidad: el tiempo, los MB/s reales y dónde está el cuello de botella.',
    '1 GB a 100 Mbps leva 85 segundos. Para os 336 cruzamentos de tamanho e velocidade: o tempo, os MB/s reais e onde está o gargalo.',
    '100Mbpsで1GBは85秒。ファイルサイズと回線速度が出会う240マスごとの所要時間、実際のMB/s、どこが詰まるかまで計算しました。',
    '1 GB über 100 Mbit/s dauert 85 Sekunden. Für alle 336 Kombinationen aus Dateigröße und Leitung: die Zeit, die echten MB/s und wo der Engpass sitzt.',
    '1 Go à 100 Mb/s prend 85 secondes. Pour les 336 croisements taille × débit : le temps, les Mo/s réels et où se situe le goulot.',
