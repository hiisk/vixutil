 ...
 * 영어 심리테스트.
 *
 * 한국어 228종은 데이터가 3만 줄에 달하고 상당수가 한국 맥락(회사 문화·연애
...
export const TESTS_EN: Test[] = [
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🕯️', title: 'Deep recharger', color: 'from-slate-500 to-slate-700',
      ...
      { min: 8, max: 14, emoji: '🌙', title: 'Quiet reserve', color: 'from-indigo-500 to-violet-600',
      ...
      { min: 15, max: 21, emoji: '🌤️', title: 'Balanced charge', color: 'from-sky-500 to-blue-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'Powered by people', color: 'from-amber-400 to-orange-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🫧', title: 'Absorbs everything', color: 'from-blue-500 to-indigo-700',
      ...
      { min: 8, max: 14, emoji: '🌧️', title: 'Weathers it slowly', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '⛅', title: 'Steady under load', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🗿', title: 'Calm in the storm', color: 'from-slate-600 to-slate-800',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🔍', title: 'The deliberator', color: 'from-slate-500 to-slate-700',
      ...
      { min: 8, max: 14, emoji: '⚖️', title: 'The weigher', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 15, max: 21, emoji: '🎯', title: 'The decider', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'The instinctive', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🎯', title: 'Deep worker', color: 'from-indigo-500 to-violet-700',
      ...
      { min: 8, max: 14, emoji: '📋', title: 'Steady planner', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '🔄', title: 'Flexible mover', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🔥', title: 'Pressure performer', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: 'A partner has had an awful day. You:', opts: [
        { text: 'Tell them exactly what you appreciate about them', score: 0 },
        { text: 'Sit with them without saying much', score: 1 },
        { text: 'Quietly take something off their plate', score: 2 },
        { text: 'Bring back something they like', score: 3 }] },
      { q: 'What makes you feel most cared for?', opts: [
        { text: 'Being told, out loud', score: 0 }, { text: 'Undivided time together', score: 1 },
        { text: 'Someone handling something for me', score: 2 }, { text: 'A thoughtful object', score: 3 }] },
      { q: 'Your instinct on an anniversary:', opts: [
        { text: 'Write something', score: 0 }, { text: 'Plan a whole day together', score: 1 },
        { text: 'Do something practical they have needed', score: 2 }, { text: 'Find the right present', score: 3 }] },
      { q: 'What hurts most in a relationship?', opts: [
        { text: 'Never hearing that it is going well', score: 0 }, { text: 'Being physically there but distracted', score: 1 },
        { text: 'Being left to handle everything', score: 2 }, { text: 'Being forgotten on the day that mattered', score: 3 }] },
      { q: 'A friend is going through something hard:', opts: [
        { text: 'I tell them what I think of them', score: 0 }, { text: 'I clear an evening for them', score: 1 },
        { text: 'I sort out something practical', score: 2 }, { text: 'I send them something', score: 3 }] },
      { q: 'You show you missed someone by:', opts: [
        { text: 'Saying it directly', score: 0 }, { text: 'Making time immediately', score: 1 },
        { text: 'Doing something for them', score: 2 }, { text: 'Bringing something back', score: 3 }] },
      { q: 'The compliment that lands hardest:', opts: [
        { text: 'Something specific about who I am', score: 0 }, { text: '"I always want more time with you"', score: 1 },
        { text: '"You always take care of things"', score: 2 }, { text: '"I saw this and thought of you"', score: 3 }] },
      { q: 'In an argument, what repairs it fastest?', opts: [
        { text: 'Hearing what they still value in me', score: 0 }, { text: 'Sitting down properly to talk', score: 1 },
        { text: 'Them doing something that shows it', score: 2 }, { text: 'A gesture that says they thought about it', score: 3 }] },
      { q: 'Your partner is away for a month. You:', opts: [
        { text: 'Send long messages', score: 0 }, { text: 'Schedule calls religiously', score: 1 },
        { text: 'Handle everything at home so they need not worry', score: 2 }, { text: 'Post things to them', score: 3 }] },
      { q: 'Which would you notice missing first?', opts: [
        { text: 'Being told how they feel', score: 0 }, { text: 'Real time together', score: 1 },
        { text: 'Being helped without asking', score: 2 }, { text: 'Small thoughtful surprises', score: 3 }] },
    ],
    results: [
      { min: 0, max: 7, emoji: '💬', title: 'Words', color: 'from-sky-500 to-blue-600',
      ...
      { min: 8, max: 14, emoji: '⏳', title: 'Time', color: 'from-violet-500 to-purple-600',
      ...
      { min: 15, max: 21, emoji: '🛠️', title: 'Acts', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🎁', title: 'Tokens', color: 'from-rose-400 to-pink-600',
