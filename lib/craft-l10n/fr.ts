...
export const CRAFT_FR: Record<string, FormulaText> = {
  ...
  'granny-square-size': {
    ...
    long: 'Un motif pousse vers l’extérieur des quatre côtés : chaque tour ajoute donc deux fois sa propre croissance au côté. Avec un tour qui mesure 2 cm, six tours donnent un carré de 24 cm. Demander 30 cm impose huit tours (32 cm), parce que sept s’arrêtent à 28 — on ne travaille pas un demi-tour, et une taille visée tombe donc rarement pile.',
    note: 'La croissance par tour vient de la laine et du crochet. Le premier tour est un paquet de brides tassé dans le cercle magique et sort plus étroit que les autres, et le nombre de mailles en l’air à chaque angle déplace chaque tour de 2 à 3 mm. Travaille trois tours, mesure un côté et divise par six — deux fois le nombre de tours, puisque chaque tour allonge les deux bouts de ce côté. Un côté de 12 cm veut dire 2 cm par tour, et c’est ce chiffre-là qu’il faut remettre dans ce calculateur.',
  },
  'granny-blanket-squares': {
    ...
    note: '102 cm, c’est 18 cm de moins que les 120 cm demandés, parce que la division arrondit vers le bas. Il faut choisir : ajouter une sixième colonne et dépasser à 122,5 cm, ou crocheter une bordure de 9 cm pour combler l’écart. Les motifs faits main varient aussi d’un carré à l’autre : bloque-les tous à la même taille avant de les assembler. La largeur de l’assemblage dépend de la méthode — presque nulle en mailles coulées, 0,5 à 1 cm avec des mailles en l’air, plus de 1 cm en mailles serrées.',
  },
  'amigurumi-increase': {
