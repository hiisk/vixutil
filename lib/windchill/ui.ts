...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '체감온도 336가지 — 기온과 바람이 만드는 추위',
    '336 wind chills — what temperature and wind add up to',
    '336 sensaciones térmicas — lo que suman temperatura y viento',
    '336 sensações térmicas — o que temperatura e vento somam',
    '体感温度210通り — 気温と風がつくる寒さ',
    '336 Windchill-Werte — was Temperatur und Wind zusammen ergeben',
    '336 refroidissements éoliens — ce que la température et le vent additionnent',
    '210 विंड चिल — तापमान और हवा मिलकर क्या बनाते हैं',
    '336 种体感温度 — 气温和风合起来有多冷',
    '336 種體感溫度 — 氣溫和風合起來有多冷',
  ),

  hubLead: T(
    '기온 21가지와 풍속 16가지가 만나는 칸마다 체감온도를 계산했습니다. 영하 10도에 시속 30km 바람이면 체감은 영하 20도쯤입니다.',
    'A wind chill for every meeting of 21 temperatures and 16 wind speeds. At −10 °C with a 30 km/h wind, it feels like about −20 °C.',
    'Una sensación térmica para cada cruce de 21 temperaturas y 16 velocidades de viento. A −10 °C con viento de 30 km/h se siente como −20 °C.',
    'Uma sensação térmica para cada cruzamento de 21 temperaturas e 16 velocidades de vento. A −10 °C com vento de 30 km/h, parece −20 °C.',
    '気温21通りと風速10通りが出会う各マスの体感温度を計算しました。氷点下10度で時速30kmの風なら体感は氷点下20度ほどです。',
    'Für jede Begegnung von 21 Temperaturen und 16 Windgeschwindigkeiten ein Windchill-Wert. Bei −10 °C und 30 km/h fühlt es sich wie −20 °C an.',
    'Un refroidissement éolien pour chaque croisement de 21 températures et 16 vitesses de vent. À −10 °C avec 30 km/h, on ressent environ −20 °C.',
    '21 तापमान और 10 हवा-गतियों के हर मेल के लिए विंड चिल। −10 °C पर 30 किमी/घंटा हवा हो तो लगभग −20 °C जैसा लगता है।',
    '21 种气温与 16 种风速交汇的每一格都算出体感温度。零下 10 度、风速 30 公里时，体感约为零下 20 度。',
    '21 種氣溫與 16 種風速交匯的每一格都算出體感溫度。零下 10 度、風速 30 公里時，體感約為零下 20 度。',
  ),
  ...
  hubMetaTitle: T(
    '체감온도표 — 기온과 풍속으로 보는 336칸',
    'Wind chill chart — 336 cells of temperature and wind',
    'Tabla de sensación térmica — 336 casillas de temperatura y viento',
    'Tabela de sensação térmica — 336 células de temperatura e vento',
    '体感温度表 — 気温と風速で見る210マス',
    'Windchill-Tabelle — 336 Felder aus Temperatur und Wind',
    'Table du refroidissement éolien — 336 cases de température et de vent',
