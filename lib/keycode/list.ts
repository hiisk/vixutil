...
const SPECIAL: KeyDef[] = [
  ...
  /* 미디어·브라우저 키 — 노트북 상단 줄과 멀티미디어 키보드에 실제로 있다.
     그룹을 새로 만들면 열 언어 라벨이 따라오므로 system에 넣는다 */
  k('AudioVolumeMute', 'AudioVolumeMute', 173, 'system'),
  k('AudioVolumeDown', 'AudioVolumeDown', 174, 'system'),
  k('AudioVolumeUp', 'AudioVolumeUp', 175, 'system'),
  k('MediaTrackNext', 'MediaTrackNext', 176, 'system'),
  k('MediaTrackPrevious', 'MediaTrackPrevious', 177, 'system'),
  k('MediaStop', 'MediaStop', 178, 'system'),
  k('MediaPlayPause', 'MediaPlayPause', 179, 'system'),
  k('LaunchMail', 'LaunchMail', 180, 'system'),
  k('LaunchApp2', 'LaunchApp2', 183, 'system'),
  k('LaunchApp1', 'LaunchApp1', 182, 'system'),
  k('BrowserBack', 'BrowserBack', 166, 'system'),
  k('BrowserForward', 'BrowserForward', 167, 'system'),
  k('BrowserRefresh', 'BrowserRefresh', 168, 'system'),
  k('BrowserStop', 'BrowserStop', 169, 'system'),
  k('BrowserSearch', 'BrowserSearch', 170, 'system'),
  k('BrowserFavorites', 'BrowserFavorites', 171, 'system'),
  k('BrowserHome', 'BrowserHome', 172, 'system'),
  k('Power', 'Power', 0, 'system'),
  k('Sleep', 'Sleep', 95, 'system'),
  k('WakeUp', 'WakeUp', 0, 'system'),

  /* 편집·부가 키 — 옛 키보드와 유닉스 배열에 남아 있다 */
  k('NumpadEqual', '=', 12, 'numpad'),
  k('NumpadComma', ',', 194, 'numpad'),
  k('NumpadParenLeft', '(', 0, 'numpad'),
  k('NumpadParenRight', ')', 0, 'numpad'),
  k('Undo', 'Undo', 0, 'editing'),
  k('Cut', 'Cut', 0, 'editing'),
  k('Copy', 'Copy', 0, 'editing'),
  k('Paste', 'Paste', 0, 'editing'),
  k('Again', 'Again', 0, 'editing'),
  k('Find', 'Find', 0, 'editing'),
  k('Help', 'Help', 47, 'editing'),
  k('Select', 'Select', 41, 'editing'),
  k('Open', 'Open', 43, 'editing'),
  k('Props', 'Props', 0, 'editing'),
  k('Fn', 'Fn', 0, 'modifier'),
  k('F21', 'F21', 132, 'function'),
  k('F22', 'F22', 133, 'function'),
  k('F23', 'F23', 134, 'function'),
  k('F24', 'F24', 135, 'function'),
];
