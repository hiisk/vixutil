 ...
 */
import { METRO_LANGS, metroAlternates, type L8, type MetroLang } from './lang.ts';
...
export const METRO_UI: L8<MetroUI> = { ko, en, es, pt, ja, de, fr, hi };
