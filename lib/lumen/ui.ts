...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '방 밝기 240칸 — 20제곱미터 거실은 3000루멘',
    '240 lighting figures — a 20 m² living room needs 3000 lumens',
    '240 cálculos de luz — un salón de 20 m² pide 3000 lúmenes',
    '240 cálculos de luz — uma sala de 20 m² pede 3000 lúmens',
    '部屋の明るさ160マス — 20平方メートルのリビングは3000ルーメン',
    '240 Beleuchtungswerte — ein 20-m²-Wohnzimmer braucht 3000 Lumen',
    '240 calculs d’éclairage — un salon de 20 m² demande 3000 lumens',
    '160 रोशनी गणनाएँ — 20 m² की बैठक को 3000 लुमेन चाहिए',
    '240 个照明数值 — 20 平方米客厅需要 3000 流明',
    '240 個照明數值 — 20 平方公尺客廳需要 3000 流明',
  ),

  hubLead: T(
    '방 넓이 20가지와 쓰임 12가지가 만나는 칸마다 필요한 루멘과 광원별 소비 전력을 계산했습니다. 와트는 밝기가 아니라 전기 먹는 양이라, 시작은 언제나 루멘입니다.',
    'For every meeting of 20 room sizes and 12 uses: the lumens you need and what each kind of lamp burns to make them. Watts measure electricity, not brightness, so the calculation starts from lumens.',
    'Para cada cruce de 20 tamaños de habitación y 12 usos: los lúmenes necesarios y lo que consume cada tipo de lámpara. Los vatios miden electricidad, no brillo, así que se empieza por los lúmenes.',
    'Para cada cruzamento de 20 tamanhos de cômodo e 12 usos: os lúmens necessários e o que cada tipo de lâmpada consome. Watts medem eletricidade, não brilho, então começa-se pelos lúmens.',
    '部屋の広さ20通りと用途8通りが出会う各マスの必要ルーメンと、光源ごとの消費電力を計算しました。ワットは明るさではなく電気の量なので、出発点はいつもルーメンです。',
    'Für jede Begegnung von 20 Raumgrößen und 12 Nutzungen: die nötigen Lumen und was jede Lampenart dafür verbraucht. Watt messen Strom, nicht Helligkeit — gerechnet wird darum ab Lumen.',
    'Pour chaque croisement de 20 surfaces et 12 usages : les lumens nécessaires et ce que chaque type de lampe consomme. Le watt mesure l’électricité, pas la lumière : on part donc des lumens.',
    ...
    '20 种房间面积与 12 种用途交汇的每一格都算出所需流明，以及各类光源为此要耗多少电。瓦数量的是电，不是亮度，所以一切从流明开始。',
    '20 種房間面積與 12 種用途交匯的每一格都算出所需流明，以及各類光源為此要耗多少電。瓦數量的是電，不是亮度，所以一切從流明開始。',
  ),
  ...
  hubMetaDesc: T(
    '20제곱미터 거실은 3000루멘, LED로 30와트입니다. 방 넓이와 쓰임이 만나는 240칸마다 필요한 루멘·전구 개수·광원별 소비 전력을 계산했습니다.',
    'A 20 m² living room needs 3000 lumens — 30 watts of LED. For all 240 pairings of room size and use: the lumens, the number of bulbs, and what each lamp type burns.',
    'Un salón de 20 m² pide 3000 lúmenes, 30 vatios de LED. Para los 240 cruces de tamaño y uso: lúmenes, número de bombillas y consumo de cada tipo de lámpara.',
    'Uma sala de 20 m² pede 3000 lúmens — 30 watts de LED. Para os 240 cruzamentos de tamanho e uso: lúmens, número de lâmpadas e consumo de cada tipo.',
    '20平方メートルのリビングは3000ルーメン、LEDなら30ワットです。広さと用途が出会う160マスごとの必要ルーメン・電球の数・光源別の消費電力を計算しました。',
    'Ein 20-m²-Wohnzimmer braucht 3000 Lumen — 30 Watt LED. Für alle 240 Kombinationen aus Raumgröße und Nutzung: Lumen, Lampenzahl und Verbrauch je Lampenart.',
    'Un salon de 20 m² demande 3000 lumens, soit 30 watts de LED. Pour les 240 croisements surface × usage : lumens, nombre d’ampoules et consommation par type de lampe.',
