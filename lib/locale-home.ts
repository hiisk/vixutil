...
const SECTIONS: HomeSection[] = [
  ...
  {
    route: '/ring', icon: '💍', color: 'from-rose-500 to-pink-400',
    accent: 'text-rose-700 dark:text-rose-200', border: 'border-rose-200 dark:border-rose-800', bg: 'bg-rose-50 dark:bg-rose-900/40',
    copy: {
      en: { title: 'Ring Size', desc: 'One inside circumference gives the US, Japanese and EU size' },
      es: { title: 'Talla de anillo', desc: 'Una circunferencia interior da la talla de EE. UU., Japón y la UE' },
      'pt-br': { title: 'Tamanho de anel', desc: 'Uma circunferência interna dá o tamanho dos EUA, do Japão e da UE' },
      ja: { title: '指輪のサイズ', desc: '内周ひとつでUS・日本号数・EUサイズが出る' },
      de: { title: 'Ringgröße', desc: 'Ein Innenumfang ergibt US-, japanische und EU-Größe' },
      fr: { title: 'Taille de bague', desc: 'Un tour intérieur donne la taille US, japonaise et UE' },
      hi: { title: 'अंगूठी का नाप', desc: 'एक भीतरी घेरे से US, जापानी और EU नाप निकल आते हैं' },
      'zh-hans': { title: '戒指尺寸', desc: '一个内周就能换出美国、日本、欧盟三种号' },
      'zh-hant': { title: '戒指尺寸', desc: '一個內周就能換出美國、日本、歐盟三種號' },
    },
  },
  {
    ...
    accent: 'text-sky-700 dark:text-sky-200', border: 'border-sky-200 dark:border-sky-800', bg: 'bg-sky-50 dark:bg-sky-900/40',
    copy: {
      en: { title: 'Sun Angle and Daylight', desc: 'Noon altitude, length of day and shadow by latitude and date' },
      es: { title: 'Altura del sol y luz diurna', desc: 'Altura al mediodía, duración del día y sombra por latitud y fecha' },
      'pt-br': { title: 'Altura do sol e luz do dia', desc: 'Altura ao meio-dia, duração do dia e sombra por latitude e data' },
      ja: { title: '太陽高度と昼の長さ', desc: '緯度と日付で南中高度・昼の長さ・影の長さ' },
      de: { title: 'Sonnenhöhe und Tageslänge', desc: 'Mittagshöhe, Tageslänge und Schatten nach Breite und Datum' },
      fr: { title: 'Hauteur du soleil et durée du jour', desc: 'Hauteur à midi, durée du jour et ombre selon latitude et date' },
      hi: { title: 'सूर्य की ऊँचाई और दिन की लंबाई', desc: 'अक्षांश और तारीख़ से दोपहर की ऊँचाई, दिन की लंबाई और छाया' },
      'zh-hans': { title: '太阳高度与白天长度', desc: '按纬度和日期算正午高度、白天长度与影长' },
      'zh-hant': { title: '太陽高度與白天長度', desc: '按緯度和日期算正午高度、白天長度與影長' },
    },
  },
  {
    route: '/hardness', icon: '🚰', color: 'from-sky-700 to-cyan-400',
    accent: 'text-sky-700 dark:text-sky-200', border: 'border-sky-200 dark:border-sky-800', bg: 'bg-sky-50 dark:bg-sky-900/40',
    copy: {
      en: { title: 'Water Hardness', desc: 'One ppm figure read as German, French, British and US degrees' },
      es: { title: 'Dureza del agua', desc: 'Una cifra en ppm leída en grados alemanes, franceses, británicos y de EE. UU.' },
      'pt-br': { title: 'Dureza da água', desc: 'Um valor em ppm lido em graus alemães, franceses, britânicos e dos EUA' },
      ja: { title: '水の硬度', desc: 'ppmひとつをドイツ度・フランス度・英国度・米国gpgで読む' },
      de: { title: 'Wasserhärte', desc: 'Ein ppm-Wert in deutschen, französischen, britischen und US-Graden' },
      fr: { title: 'Dureté de l’eau', desc: 'Une valeur en ppm lue en degrés allemands, français, britanniques et US' },
      hi: { title: 'पानी की कठोरता', desc: 'एक ppm मान को जर्मन, फ़्रेंच, ब्रिटिश और US डिग्री में पढ़ें' },
      'zh-hans': { title: '水的硬度', desc: '一个 ppm 值换成德国度、法国度、英国度和美国 gpg' },
      'zh-hant': { title: '水的硬度', desc: '一個 ppm 值換成德國度、法國度、英國度和美國 gpg' },
    },
  },
  {
    route: '/steel', icon: '🔲', color: 'from-slate-600 to-sky-400',
    accent: 'text-sky-700 dark:text-sky-200', border: 'border-sky-200 dark:border-sky-800', bg: 'bg-sky-50 dark:bg-sky-900/40',
    copy: {
      en: { title: 'Steel Weight', desc: 'Plate, bar and tube by shape and size, straight from volume times density' },
      es: { title: 'Peso del acero', desc: 'Chapa, barra y tubo por forma y medida, desde volumen por densidad' },
      'pt-br': { title: 'Peso do aço', desc: 'Chapa, barra e tubo por forma e medida, a partir de volume vezes densidade' },
      ja: { title: '鋼材の重量', desc: '鋼板・棒・パイプを形状と寸法で、体積 × 密度から出す' },
      de: { title: 'Stahlgewicht', desc: 'Blech, Stab und Rohr nach Form und Maß, direkt aus Volumen mal Dichte' },
      fr: { title: 'Poids de l’acier', desc: 'Tôle, barre et tube par forme et dimension, à partir du volume fois la densité' },
      hi: { title: 'स्टील का वज़न', desc: 'प्लेट, छड़ और पाइप — आकार और नाप से, आयतन × घनत्व से निकाला' },
      'zh-hans': { title: '钢材重量', desc: '钢板、棒材、管材按形状和尺寸，由体积乘密度得出' },
      'zh-hant': { title: '鋼材重量', desc: '鋼板、棒材、管材按形狀和尺寸，由體積乘密度得出' },
    },
  },
  {
    route: '/motor', icon: '🔃', color: 'from-indigo-600 to-sky-400',
    accent: 'text-indigo-700 dark:text-indigo-200', border: 'border-indigo-200 dark:border-indigo-800', bg: 'bg-indigo-50 dark:bg-indigo-900/40',
    copy: {
      en: { title: 'Motor Torque', desc: 'Newton metres from rated output and speed, with PS/hp and 50 Hz vs 60 Hz' },
      es: { title: 'Par del motor', desc: 'Newton metro según potencia y velocidad, con PS/hp y 50 Hz frente a 60 Hz' },
      'pt-br': { title: 'Torque do motor', desc: 'Newton metro por potência e rotação, com PS/hp e 50 Hz contra 60 Hz' },
      ja: { title: 'モーターのトルク', desc: '出力と回転数でN·m、馬力換算と50Hz・60Hzの違い' },
      de: { title: 'Motordrehmoment', desc: 'Newtonmeter aus Leistung und Drehzahl, mit PS/hp und 50 Hz gegen 60 Hz' },
      fr: { title: 'Couple moteur', desc: 'Newtons-mètres selon puissance et vitesse, avec ch/hp et 50 Hz contre 60 Hz' },
      hi: { title: 'मोटर टॉर्क', desc: 'आउटपुट और गति से N·m, PS/hp और 50 Hz बनाम 60 Hz' },
      'zh-hans': { title: '电机扭矩', desc: '由功率和转速算 N·m，含马力换算与 50Hz、60Hz 之别' },
      'zh-hant': { title: '馬達扭矩', desc: '由功率和轉速算 N·m，含馬力換算與 50Hz、60Hz 之別' },
    },
  },
  {
    route: '/rebar', icon: '🏗️', color: 'from-amber-600 to-yellow-400',
    accent: 'text-amber-700 dark:text-amber-200', border: 'border-amber-200 dark:border-amber-800', bg: 'bg-amber-50 dark:bg-amber-900/40',
    copy: {
      en: { title: 'Rebar Weight', desc: 'Kilograms per bar by size and length, straight from the density of steel' },
      es: { title: 'Peso de varilla', desc: 'Kilos por varilla según calibre y longitud, a partir de la densidad del acero' },
      'pt-br': { title: 'Peso de barras de aço', desc: 'Quilos por barra conforme bitola e comprimento, a partir da densidade do aço' },
      ja: { title: '鉄筋の重量', desc: '呼び名と長さで1本の重さ、鋼の密度から出す単位質量' },
      de: { title: 'Betonstahl-Gewicht', desc: 'Kilogramm je Stab nach Größe und Länge, direkt aus der Dichte von Stahl' },
      fr: { title: 'Poids des armatures', desc: 'Kilos par barre selon calibre et longueur, à partir de la densité de l’acier' },
      hi: { title: 'सरिया का वज़न', desc: 'माप और लंबाई से प्रति सरिया किलो, स्टील के घनत्व से निकाला' },
      'zh-hans': { title: '钢筋重量', desc: '按规格和长度算每根公斤数，从钢的密度得出' },
      'zh-hant': { title: '鋼筋重量', desc: '按規格和長度算每根公斤數，從鋼的密度得出' },
    },
  },
  {
    route: '/fertilizer', icon: '🌱', color: 'from-lime-500 to-emerald-400',
    accent: 'text-lime-700 dark:text-lime-200', border: 'border-lime-200 dark:border-lime-800', bg: 'bg-lime-50 dark:bg-lime-900/40',
    copy: {
      en: { title: 'Fertilizer Amount', desc: 'From an N-P-K target to the weight to spread, by fertilizer and plot size' },
      es: { title: 'Dosis de abono', desc: 'Del objetivo N-P-K al peso a esparcir, según abono y superficie' },
      'pt-br': { title: 'Dose de adubo', desc: 'Do alvo N-P-K ao peso a espalhar, por adubo e área' },
      ja: { title: '施肥量', desc: 'N-P-Kの目標から、肥料と面積ごとにまく量を出す' },
      de: { title: 'Düngermenge', desc: 'Vom N-P-K-Ziel zur Streumenge, nach Dünger und Fläche' },
      fr: { title: 'Dose d’engrais', desc: 'De l’objectif N-P-K à la quantité à épandre, par engrais et surface' },
      hi: { title: 'उर्वरक मात्रा', desc: 'N-P-K लक्ष्य से डालने का वज़न, उर्वरक और क्षेत्रफल के अनुसार' },
      'zh-hans': { title: '施肥量', desc: '从 N-P-K 目标算出要撒多少，按肥料和面积' },
      'zh-hant': { title: '施肥量', desc: '從 N-P-K 目標算出要撒多少，按肥料和面積' },
    },
  },
  {
