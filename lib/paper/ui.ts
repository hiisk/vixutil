...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '종이 420칸 — A4 300dpi는 2480×3508',
    '420 paper sizes — A4 at 300 dpi is 2480×3508',
    '420 tamaños de papel — A4 a 300 ppp son 2480×3508',
    '420 tamanhos de papel — A4 a 300 dpi dá 2480×3508',
    '紙280マス — A4の300dpiは2480×3508',
    '420 Papierformate — A4 bei 300 dpi sind 2480×3508',
    '420 formats de papier — A4 à 300 ppp fait 2480×3508',
    '280 कागज़ आकार — 300 dpi पर A4 यानी 2480×3508',
    '420 个纸张规格 — A4 在 300dpi 下是 2480×3508',
    '420 個紙張規格 — A4 在 300dpi 下是 2480×3508',
  ),

  hubLead: T(
    '규격 35가지와 해상도 12가지가 만나는 칸마다 밀리미터·인치·픽셀과 장당 무게를 계산했습니다. A0 한 장이 1제곱미터이고, 나머지는 전부 반으로 접어서 나온 것입니다.',
    'For every meeting of 35 sizes and 12 resolutions: millimetres, inches, pixels and the weight of one sheet. A0 is one square metre, and every other size is that sheet folded in half again.',
    'Para cada cruce de 35 tamaños y 12 resoluciones: milímetros, pulgadas, píxeles y el peso de una hoja. El A0 mide un metro cuadrado y el resto sale de doblarlo por la mitad.',
    'Para cada cruzamento de 35 tamanhos e 12 resoluções: milímetros, polegadas, pixels e o peso de uma folha. O A0 tem um metro quadrado, e todo o resto sai de dobrá-lo ao meio.',
    '規格35通りと解像度8通りが出会う各マスのミリ・インチ・ピクセルと1枚の重さを計算しました。A0が1平方メートルで、残りはすべて半分に折って出てきます。',
    'Für jede Begegnung von 35 Formaten und 12 Auflösungen: Millimeter, Zoll, Pixel und das Gewicht eines Blattes. A0 ist ein Quadratmeter, alles andere entsteht durch Halbieren.',
    'Pour chaque croisement de 35 formats et 12 résolutions : millimètres, pouces, pixels et le poids d’une feuille. Le A0 fait un mètre carré, et tout le reste vient de le plier en deux.',
    ...
    '35 种规格与 12 种分辨率交汇的每一格都算出毫米、英寸、像素和单张重量。A0 正好一平方米，其余全是把它对折出来的。',
    '35 種規格與 12 種解析度交匯的每一格都算出公釐、英寸、像素和單張重量。A0 正好一平方公尺，其餘全是把它對折出來的。',
  ),
  ...
  hubMetaDesc: T(
    'A4는 210×297mm이고 300dpi로는 2480×3508픽셀입니다. 규격 35가지와 해상도 12가지가 만나는 420칸마다 밀리미터·인치·픽셀·장당 무게를 계산했습니다.',
    'A4 is 210×297 mm, or 2480×3508 pixels at 300 dpi. For all 420 pairings of 35 sizes and 12 resolutions: millimetres, inches, pixels and the weight of a sheet.',
    'El A4 mide 210×297 mm, o 2480×3508 píxeles a 300 ppp. Para los 420 cruces de 35 tamaños y 12 resoluciones: milímetros, pulgadas, píxeles y peso por hoja.',
    'O A4 mede 210×297 mm, ou 2480×3508 pixels a 300 dpi. Para os 420 cruzamentos de 35 tamanhos e 12 resoluções: milímetros, polegadas, pixels e peso por folha.',
    'A4は210×297mm、300dpiなら2480×3508ピクセルです。規格35通りと解像度8通りが出会う280マスごとのミリ・インチ・ピクセル・1枚の重さを計算しました。',
    'A4 misst 210×297 mm, bei 300 dpi 2480×3508 Pixel. Für alle 420 Kombinationen aus 35 Formaten und 12 Auflösungen: Millimeter, Zoll, Pixel und Blattgewicht.',
    'L’A4 fait 210×297 mm, soit 2480×3508 pixels à 300 ppp. Pour les 420 croisements de 35 formats et 12 résolutions : millimètres, pouces, pixels et poids de la feuille.',
    ...
    'A4 是 210×297mm，300dpi 下为 2480×3508 像素。35 种规格与 12 种分辨率交汇的 280 格，每格的毫米、英寸、像素与单张重量。',
    'A4 是 210×297mm，300dpi 下為 2480×3508 像素。35 種規格與 12 種解析度交匯的 280 格，每格的公釐、英寸、像素與單張重量。',
  ),
