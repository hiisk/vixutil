...
export const SECTION_FAQ: Record<string, FaqItem[]> = {
  ...
  worldcup: [
    {
      q: '이상형 월드컵은 어떻게 하나요?',
      a: '둘 중 더 끌리는 하나를 고르면 됩니다. 16강부터 시작해 8강·준결승·결승을 거치며 후보가 절반씩 줄고, 마지막까지 살아남은 하나가 당신의 최애 우승자가 됩니다.',
    },
    {
      q: '할 때마다 순서가 달라지나요?',
      a: '네, 시작할 때마다 대진표를 무작위로 섞습니다. 그래서 매번 다른 매치업이 나오고, 결과도 그날의 기분에 따라 달라질 수 있어 여러 번 즐기기 좋습니다.',
    },
    {
      q: '결과를 친구와 공유할 수 있나요?',
      a: '우승이 결정되면 공유 버튼으로 결과를 바로 보낼 수 있습니다. 같은 월드컵을 친구도 돌려보고 서로의 최애를 비교해 보세요.',
    },
  ],
  generator: [
    {
