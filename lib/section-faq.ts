...
export const SECTION_FAQ: Record<string, FaqItem[]> = {
  ...
  "random/card": [
    {
      q: "같은 카드가 두 번 나올 수 있나요?",
      a: "나오지 않습니다. 52장 한 벌을 섞어 위에서부터 가져오기 때문입니다. 매번 52장 중에서 따로 뽑는 방식이면 같은 카드가 두 장 나와 카드놀이로 쓸 수 없습니다.",
    },
    {
      q: "조커는 없나요?",
      a: "없습니다. 표준 52장만 씁니다. 조커가 필요한 놀이라면 뽑은 결과에 따로 정해 두는 편이 낫습니다.",
    },
    {
      q: "결과가 정말 무작위인가요?",
      a: "브라우저의 난수를 씁니다. 카드 순서를 섞을 때는 피셔-예이츠 방식을 써서 어느 자리에나 어느 카드든 같은 확률로 옵니다.",
    },
  ],
  "random/rps": [
    {
      q: "컴퓨터가 제 손을 보고 내나요?",
      a: "보지 않습니다. 손을 고른 뒤에 컴퓨터가 무작위로 냅니다. 세 손이 나오는 비율도 고르게 맞춰져 있습니다.",
    },
    {
      q: "전적은 어디에 저장되나요?",
      a: "저장되지 않습니다. 화면을 새로 고치면 0부터 다시 셉니다.",
    },
  ],
  "random/bingo": [
    {
      q: "숫자가 겹치지 않나요?",
      a: "겹치지 않습니다. 1부터 칸 수까지를 통째로 섞어 채우기 때문에 같은 수가 두 번 들어가지 않습니다. 겹치면 그 수가 불렸을 때 두 칸이 함께 지워져 빙고가 빨리 나 버립니다.",
    },
    {
      q: "가운데 무료 칸이 안 켜집니다.",
      a: "짝수 판(4×4 등)에는 한가운데 칸이 없어서 켤 수 없습니다. 3×3이나 5×5에서만 켜집니다.",
    },
    {
      q: "여러 명이 같이 하려면요?",
      a: "각자 기기에서 새 판을 만들면 서로 다른 판이 나옵니다. 부를 숫자는 따로 정하거나 숫자 추첨(/random/number)을 쓰세요.",
    },
  ],
  "random/weighted": [
    {
      q: "가중치는 어떤 단위인가요?",
      a: "단위가 없습니다. 서로의 비율만 뜻이 있어서 1:3:6과 10:30:60이 같습니다. 화면에 나오는 %가 실제 확률입니다.",
    },
    {
      q: "가중치를 0으로 두면요?",
      a: "뽑히지 않습니다. 목록에서 지우지 않고 잠시 빼 두고 싶을 때 쓰세요.",
    },
    {
      q: "확률 합이 100이 안 맞아 보입니다.",
      a: "반올림 때문입니다. 셋을 3등분하면 33.3씩이라 합이 99.9가 되므로, 남는 몫을 가장 큰 항목에 더해 합이 정확히 100이 되게 맞췄습니다.",
    },
  ],
  "random/duty": [
    {
      q: "같은 사람이 계속 걸리지 않나요?",
      a: "걸리지 않습니다. 명단을 섞어 한 바퀴씩 쓰기 때문에 모두가 한 번씩 할 때까지 같은 사람이 두 번 오지 않습니다. 바퀴가 바뀔 때 앞 바퀴 마지막 사람이 첫 자리에 오면 자리를 바꿔 연달아 오는 것도 막습니다.",
    },
    {
      q: "사람 수로 나누어떨어지지 않으면요?",
      a: "마지막 바퀴가 중간에 끊깁니다. 그래서 사람별 횟수가 한 번씩 차이 날 수 있고, 화면 아래에 각자 몇 번인지 보여 줍니다.",
    },
    {
      q: "만든 표를 저장할 수 있나요?",
      a: "저장 기능은 없습니다. 화면을 캡처하거나 옮겨 적어 두세요. 다시 만들면 다른 표가 나옵니다.",
    },
  ],
  "random/yes-no": [
    {
      q: "\"예\" 확률을 왜 조절하나요?",
      a: "두 가지 쓸모가 있습니다. 하나는 마음이 한쪽으로 기운 결정을 그대로 반영하는 것이고, 다른 하나는 답이 나왔을 때의 기분을 보는 것입니다. 아쉬우면 이미 답을 알고 있는 겁니다.",
    },
    {
      q: "0이나 100으로 두면 무슨 뜻인가요?",
      a: "한쪽만 나옵니다. 무작위가 아니게 되지만, 정해진 답을 눈으로 보고 싶을 때 씁니다.",
    },
    {
      q: "질문은 저장되나요?",
      a: "저장되지 않습니다. 화면 안에서만 쓰이고 어디로도 보내지 않습니다.",
    },
  ],
  'random/coin-dice': [
    {
  ...
  'fortune/ilju': [
    {
      q: '내 일주는 어떻게 아나요?',
      a: '태어난 날의 간지입니다. 생년월일을 넣으면 사주 분석에서 네 기둥이 나오고, 그중 셋째 기둥이 일주입니다. 시각은 몰라도 됩니다 — 일주는 «날»이 정하지 «시각»이 정하지 않습니다.',
    },
    {
      q: '왜 120가지가 아니라 60가지인가요?',
      a: '천간 열과 지지 열둘이 아무렇게나 만나지 않기 때문입니다. 둘의 짝수·홀수(음양)가 맞아야 해서 「갑축」 같은 조합은 존재하지 않습니다. 그래서 10 × 12 = 120이 아니라 60가지입니다.',
    },
    {
      q: '일주만 보고 사주를 판단해도 되나요?',
      a: '안 됩니다. 사주는 여덟 글자인데 일주는 그중 둘입니다. 다만 일간이 «나 자신»이고 일지가 «내가 앉은 자리»라 여덟 글자 가운데 나를 가장 많이 말하는 둘이기도 합니다. 큰 줄기를 잡는 데는 쓸 만하고, 세부는 나머지 여섯 글자를 함께 봐야 합니다.',
    },
    {
      q: '공망이 있으면 나쁜 건가요?',
      a: '«비어 있다»는 뜻이지 «나쁘다»가 아닙니다. 그 자리가 뜻하는 것이 손에 잘 안 잡힌다고 보는데, 반대로 그 자리에 매이지 않는다는 뜻이기도 합니다. 재물 자리가 공망이면 돈에 집착이 적고, 관 자리가 공망이면 조직에 매이지 않는 식으로 읽습니다.',
    },
    {
      q: '일지가 배우자궁이라는 게 무슨 뜻인가요?',
      a: '일간 바로 아래, 가장 가까운 자리라서 «내 곁에 있는 사람»을 뜻한다고 봅니다. 그래서 일간과 일지의 관계를 배우자와의 결로 읽습니다 — 서로 낳아 주면 편안하고, 치면 부딪히되 다듬어 준다고 봅니다.',
    },
  ],
  'fortune/unseong': [
    {
      q: '「사」나 「절」이 나왔는데 나쁜 건가요?',
      a: '아닙니다. 명리에서 십이운성은 좋고 나쁨이 아니라 기운의 «모양»입니다. 사는 바깥일이 줄고 안이 깊어지는 자리라 연구·기술·글처럼 혼자 파고드는 일과 맞고, 절은 앞의 것이 끊긴 자리라 판을 갈아엎는 결정과 맞습니다. 강한 자리만 좋은 사주라면 모두가 제왕을 원할 텐데, 실제로는 제왕이 넷이면 넘친다고 봅니다.',
    },
    {
      q: '갑과 을은 같은 목(木)인데 왜 결과가 반대인가요?',
      a: '양간은 순행하고 음간은 역행하기 때문입니다. 갑은 해(亥)에서 장생해 앞으로 돌고, 을은 오(午)에서 장생해 뒤로 돕니다. 그래서 갑이 강한 자리에서 을이 약하고, 그 반대도 됩니다. 이 방향을 안 가르면 열 일간이 다섯 표만 쓰게 됩니다.',
    },
    {
      q: '기준이 일간인가요, 연간인가요?',
      a: '일간입니다. 십이운성은 «나 자신»인 일간이 각 지지에서 어떤 상태인가를 보는 것이라, 네 기둥 모두 일간을 기준으로 읽습니다. 연간 기준으로 보는 표는 십이신살 쪽입니다.',
    },
    {
      q: '건록과 제왕은 어떻게 다른가요?',
      a: '건록은 일간이 스스로 앉는 자리로, 남에게 기대지 않고 제 힘으로 벌어들이는 기운입니다. 제왕은 그다음 자리로 기운이 꼭대기에 오른 상태입니다. 실속은 건록이 낫다고 보는 견해가 많은데, 제왕은 꼭대기 다음이 내리막이기 때문입니다.',
    },
    {
      q: '십이신살과 무엇이 다른가요?',
      a: '십이신살은 삼합 무리가 정하고 «어떤 성격의 일이 붙는가»를 봅니다(도화·역마·화개). 십이운성은 일간이 정하고 «내 힘이 얼마나 센가»를 봅니다. 둘은 서로 다른 축이라 함께 봅니다.',
    },
  ],
  'fortune/sinsal': [
    {
      q: '연지 기준과 일지 기준의 결과가 다른데 어느 쪽이 맞나요?',
      a: '둘 다 쓰입니다. 옛 책은 태어난 해의 지지(연지)를 기준으로 삼았고, 요즘 실무에서는 일지를 기준으로 보는 쪽이 많습니다. 유파에 따라 갈리는 부분이라 이 계산기는 두 기준을 모두 보여줍니다. 다른 사이트와 결과가 다르다면 기준이 다른 것일 가능성이 큽니다.',
    },
    {
      q: '도화살이 있으면 나쁜 건가요?',
      a: '아닙니다. «살»이라는 말이 무섭게 들리지만 본디 뜻은 기운의 성격입니다. 도화살은 사람 눈을 끄는 매력을 뜻해서, 남 앞에 서는 일 — 연예·영업·강의·창작 — 에서는 오히려 재산에 가깝게 봅니다. 옛날에 나쁘게 본 것은 그 시절의 생활 방식 때문입니다.',
    },
    {
      q: '역마살이 있으면 정말 떠돌게 되나요?',
      a: '역마살은 한자리에 오래 머무르지 않는 기운입니다. 농경 사회에서는 나쁘게 봤지만 지금은 이동이 곧 기회여서, 무역·항공·영업·해외 업무에서는 유리하다고 봅니다. 이사나 이직이 잦은 것 자체를 문제로 볼 필요는 없습니다.',
    },
    {
      q: '왜 도화살은 항상 자·오·묘·유에만 있나요?',
      a: '십이신살은 삼합 무리가 자리를 정하는데, 네 무리의 «왕지»가 정확히 자·오·묘·유이기 때문입니다. 도화살(년살)은 왕지에서 세 칸 앞이라 결과적으로 늘 이 넷 가운데 놓입니다. 역마살이 늘 인·신·사·해인 것, 화개살이 늘 진·술·축·미인 것도 같은 이유입니다.',
    },
    {
      q: '살이 많으면 사주가 나쁜 건가요?',
      a: '살의 개수로 좋고 나쁨을 가리지 않습니다. 네 기둥에 지지가 넷뿐이라 누구나 몇 가지는 갖게 되고, 두 기준으로 보면 대개 대여섯이 나옵니다. 살은 사주를 읽는 여러 도구 가운데 하나일 뿐이고, 무엇보다 이 계산기는 오락·참고용입니다.',
    },
  ],
  'fortune/samjae': [
    {
      q: '삼재에 걸리면 나쁜 일이 생기나요?',
      a: '정해진 것은 없습니다. 삼재의 «삼»은 세 해가 아니라 세 가지 재앙 — 불·물·바람 — 을 뜻하고, 자연재해와 흉년이 삶을 흔들던 시절에 «열두 해 가운데 세 해쯤은 조심해서 지내자»고 정해 둔 달력에 가깝습니다. 큰 결정을 한 번 더 따져 보라는 표시로 읽는 편이 맞습니다.',
    },
    {
      q: '왜 저 말고 다른 띠도 같이 삼재인가요?',
      a: '삼재는 띠 하나가 아니라 삼합이라는 무리 셋이 함께 들기 때문입니다. 예를 들어 돼지·토끼·양띠는 한 무리라 늘 같은 해에 삼재가 옵니다. 네 무리의 구간이 열두 지지를 빈틈없이 나눠 갖기 때문에, 어느 해든 삼재인 띠는 정확히 셋입니다.',
    },
    {
      q: '들삼재·눌삼재·날삼재는 무엇이 다른가요?',
      a: '드는 해가 가장 세고 나가는 해가 가장 약하다고 봅니다. 가운데 눌삼재는 «눕는다»는 뜻으로 큰일이 터지기보다 잔일이 길게 이어진다고 하고요. 다만 «나가면서 한 번 크게 흔든다»며 마지막 해를 더 조심하라는 지방도 있어, 지역마다 말이 조금씩 다릅니다.',
    },
    {
      q: '삼재는 몇 년에 한 번 오나요?',
      a: '열두 해에 한 번, 세 해씩입니다. 삼재가 끝나면 아홉 해 동안은 삼재가 없습니다.',
    },
    {
      q: '양력 생일과 음력 생일 중 무엇으로 봐야 하나요?',
      a: '삼재는 태어난 «날»이 아니라 태어난 해의 띠만 보기 때문에 대부분 상관없습니다. 다만 1월이나 2월 초에 태어났다면 띠가 갈릴 수 있습니다 — 사주에서는 입춘(2월 4일 무렵)을 해의 경계로 보기 때문입니다. 그 무렵 생일이면 앞뒤 띠를 모두 확인해보세요.',
    },
  ],
  'fortune/saju-match': [
    {
      q: '태어난 시각을 모르는데 궁합을 볼 수 있나요?',
      a: '볼 수 있습니다. 궁합에서 실제로 보는 자리는 태어난 «날»의 두 글자 — 일간과 일지 — 이고, 시각은 시주 한 기둥에만 영향을 줍니다. 시각을 비우면 오행 개수가 조금 달라져 오행 보완 점수만 살짝 움직입니다.',
    },
    {
      q: '두 사람을 넣는 순서가 결과를 바꾸나요?',
      a: '네 자리 가운데 십성만 바뀝니다. 십성은 «상대가 내 사주에서 무엇이 되는가»라 방향이 있는 자리여서, 첫 번째 사람을 기준으로 봅니다. 일간·배우자궁·오행 세 자리는 두 사람의 관계 자체라 순서를 바꿔도 같습니다.',
    },
    {
      q: '점수가 낮게 나왔어요. 헤어져야 하나요?',
      a: '아닙니다. 명리에서 상극과 충은 «나쁘다»가 아니라 «부딪히며 다듬는다»로 봅니다. 오래 사는 부부 중에도 일지가 충인 경우가 흔하고, 그런 관계는 서로 떨어져 지내는 시간이 있으면 오히려 편하다고 봅니다. 무엇보다 이것은 오락·참고용입니다.',
    },
    {
      q: '궁합이 좋다는 건 정확히 무슨 뜻인가요?',
      a: '대개 «오행이 서로를 메운다»는 뜻입니다. 내 사주에 없는 기운을 상대가 갖고 있으면 곁에 있을 때 부족한 자리가 채워집니다. 반대로 두 사람이 같은 오행만 잔뜩 갖고 있으면 편하기는 해도 함께 약한 자리가 남습니다.',
    },
    {
      q: '띠 궁합·별자리 궁합과 무엇이 다른가요?',
      a: '띠 궁합은 태어난 «해»의 지지 하나만 봅니다. 사주 궁합은 생년월일시 여덟 글자를 모두 세운 뒤 그중 관계에 관여하는 네 자리를 봅니다. 같은 띠여도 태어난 날이 다르면 결과가 달라지는 것이 그 차이입니다.',
    },
  ],
  'fortune/name-match': [
    {
  ...
  "snap/face-thirds": [
    {
      q: "이마 높이는 어떻게 재나요?",
      a: "재지 못합니다. 얼굴에서 뽑는 점 예순여덟 개에는 머리카락 경계가 없어서 이마 위쪽 끝을 알 수 없습니다. 그래서 위 칸은 가운데 칸(눈썹~코 밑)과 같다고 두고 어림합니다. 실제 이마가 그보다 넓거나 좁으면 위 칸 값이 그만큼 어긋납니다.",
    },
    {
      q: "세 칸이 고르면 좋은 얼굴인가요?",
      a: "아닙니다. 삼등분은 그림을 그릴 때 얼굴 비례를 잡던 오래된 관습이지 아름다움의 기준이 아닙니다. 실제 사람의 얼굴은 대부분 셋이 고르지 않습니다.",
    },
    {
      q: "고개를 들거나 숙이면 값이 달라집니다.",
      a: "달라집니다. 고개를 숙이면 아래 칸이 짧아 보이고 들면 길어 보입니다. 정면·수평으로 찍은 사진에서 보세요.",
    },
  ],
  "snap/eye-spacing": [
    {
      q: "1이 이상적인 값인가요?",
      a: "널리 쓰이는 어림일 뿐입니다. 얼굴 너비를 다섯 등분했을 때 눈 하나가 한 칸이라는 관습에서 나온 것이고, 실제 사람은 0.8에서 1.2 사이에 넓게 흩어져 있습니다.",
    },
    {
      q: "사진을 가까이서 찍으면 달라지나요?",
      a: "비율이라 크기에는 안 흔들립니다. 다만 가까이서 찍으면 원근 왜곡으로 가운데가 커 보여 비율이 실제보다 작게 나올 수 있습니다.",
    },
  ],
  "snap/face-shape": [
    {
      q: "같은 사람인데 결과가 바뀝니다.",
      a: "얼굴형은 세로가로비와 턱·이마 너비로 가르는데, 고개를 돌리거나 숙이면 그 값들이 실제로 달라집니다. 정면 사진에서 보세요. 또 두 형의 경계에 걸친 얼굴은 조금만 달라져도 이름이 바뀝니다 — 그래서 근거가 된 세 값을 함께 보여 줍니다.",
    },
    {
      q: "머리카락이 얼굴형을 가리는데요?",
      a: "머리카락은 보지 않습니다. 턱선과 눈썹 점만 씁니다. 그래서 앞머리로 이마를 덮어도 결과가 바뀌지 않습니다.",
    },
    {
      q: "다섯 가지밖에 없나요?",
      a: "널리 쓰이는 다섯 가지로 갈랐습니다. 실제 얼굴은 그 사이 어딘가에 있으므로, 이름보다 함께 나오는 세 값을 보는 편이 정확합니다.",
    },
  ],
  "snap/brows": [
    {
      q: "눈썹 높이가 원래 다릅니다.",
      a: "사람의 눈썹은 좌우가 완전히 같은 경우가 드뭅니다. 다만 이 검사는 눈썹 자체보다 사진에서 잰 값을 보여 주는 것이라, 표정과 고개 각도에 따라 달라집니다.",
    },
    {
      q: "가까이서 찍으면 점수가 낮게 나오나요?",
      a: "나오지 않습니다. 높이 차이를 얼굴 크기로 나눠서 재기 때문에 사진 크기에 흔들리지 않습니다.",
    },
    {
      q: "눈썹을 그리면 결과가 바뀌나요?",
      a: "바뀝니다. 얼굴 점을 뽑는 모델이 보는 것은 실제 눈썹이 아니라 사진에 보이는 눈썹 모양입니다.",
    },
  ],
  "snap/lips": [
    {
      q: "\"두께를 못 잰다\"고 나옵니다.",
      a: "입술 안쪽 여덟 점을 못 찾은 것입니다. 입을 다물고 있거나 어두워서 경계가 흐리면 그렇습니다. 없는 점을 바깥 점으로 대신하면 두께가 늘 0이 되고 화면에는 \"윗입술이 없다\"는 뜻의 숫자가 그럴듯하게 나오므로, 모른다고 말하는 쪽을 골랐습니다.",
    },
    {
      q: "1:1.6이 기준인가요?",
      a: "아랫입술이 윗입술보다 조금 두꺼운 편이라는 널리 쓰이는 어림입니다. 아름다움의 기준이 아니고, 사람마다 크게 다릅니다.",
    },
    {
      q: "웃으면 결과가 달라집니다.",
      a: "달라집니다. 웃으면 입이 옆으로 늘어나 너비가 커지고 입술은 얇아 보입니다. 힘을 뺀 얼굴에서 보세요.",
    },
  ],
  "snap/contrast": [
    {
      q: "대비는 높을수록 좋은 것 아닌가요?",
      a: "아닙니다. 너무 낮으면 밋밋하고 너무 높으면 한쪽이 날아간 것이라 가운데가 가장 좋습니다. \"클수록 좋다\"로 매기면 탄 사진이 만점을 받습니다.",
    },
    {
      q: "조명 검사와 무엇이 다른가요?",
      a: "조명 검사는 빛이 어느 쪽에서 오는지를 봅니다. 이 검사는 얼마나 또렷한지를 봅니다. 옆에서 빛이 와도 대비가 알맞을 수 있고, 정면광이어도 밋밋할 수 있습니다.",
    },
  ],
  "snap/backdrop": [
    {
      q: "배경색은 안 보나요?",
      a: "보지 않습니다. 밝기만 봅니다. 그래서 흰 배경인지 파란 배경인지는 이 검사가 알려 주지 못합니다. 증명사진 규격은 나라마다 배경색을 따로 정하고 있으니 그건 따로 확인하세요.",
    },
    {
      q: "\"고름\"이 무슨 뜻인가요?",
      a: "배경의 밝기가 얼마나 한결같은지입니다. 무늬가 있거나 물건이 놓여 있으면 밝기가 들쭉날쭉해져 값이 내려갑니다.",
    },
    {
      q: "배경이 얼굴과 밝기가 비슷하면요?",
      a: "인물이 배경에서 안 떨어져 보입니다. 증명사진에서는 얼굴보다 배경이 밝은 쪽이 보통 낫습니다.",
    },
  ],
  'snap/face-reading': [
    {
  ...
  "image/watermark": [
    {
      q: "워터마크를 넣은 사진이 서버로 올라가나요?",
      a: "올라가지 않습니다. 브라우저의 캔버스에서만 그리기 때문에 사진이 기기 밖으로 나가지 않습니다. 정적 배포라 받을 서버 자체가 없습니다.",
    },
    {
      q: "\"바둑판으로 반복\"은 왜 있나요?",
      a: "귀퉁이에 하나만 있으면 그 부분만 잘라내면 그만입니다. 사진 전체에 비스듬히 깔면 지우기가 훨씬 어려워집니다. 대신 사진을 보는 데 방해가 되니 용도에 따라 고르세요.",
    },
    {
      q: "글자 크기가 사진마다 달라 보입니다.",
      a: "크기를 %로 잡아 짧은 변에 비례시킵니다. 고정 픽셀로 두면 4000px 사진에서는 안 보이고 400px 사진에서는 화면을 덮습니다.",
    },
    {
      q: "그림 워터마크(로고)도 넣을 수 있나요?",
      a: "지금은 글자만 넣습니다. 로고가 필요하면 로고를 넣은 사진을 만든 뒤 이미지 합치기(/image/merge)를 쓰는 방법이 있습니다.",
    },
  ],
  "image/adjust": [
    {
      q: "원본이 바뀌나요?",
      a: "바뀌지 않습니다. 원본 파일은 그대로 두고 보정한 결과를 새 파일로 저장합니다.",
    },
    {
      q: "큰 사진인데 느리지 않나요?",
      a: "캔버스의 filter 기능 하나로 처리하기 때문에 브라우저가 그래픽 장치로 넘깁니다. 픽셀을 하나씩 도는 방식보다 훨씬 빠릅니다.",
    },
    {
      q: "미리 맞춰 둔 값은 무엇을 바꾸나요?",
      a: "흑백은 채도를 0으로 두고 대비를 조금 올립니다. 따뜻하게는 세피아를 섞고, 차갑게는 채도를 낮추며 밝기를 올립니다. 누른 뒤 슬라이더로 더 손볼 수 있습니다.",
    },
  ],
  "image/frame": [
    {
      q: "사진이 흐려지지 않나요?",
      a: "흐려지지 않습니다. 사진을 늘리지 않고 둘레에 여백만 더합니다. 늘리면 화질이 떨어지는데, 테두리를 두르려고 화질을 버리는 것은 맞바꿈이 안 맞습니다.",
    },
    {
      q: "인스타그램에 세로 사진을 올리면 잘립니다.",
      a: "4:5로 맞추면 잘리지 않습니다. 인스타그램이 피드에서 허용하는 가장 긴 세로 비율이 4:5입니다.",
    },
    {
      q: "테두리 두께가 %인 이유는?",
      a: "짧은 변에 대한 비율입니다. 픽셀로 두면 큰 사진에서는 선처럼 얇고 작은 사진에서는 사진을 덮습니다.",
    },
  ],
  "image/round": [
    {
      q: "왜 항상 PNG로 저장되나요?",
      a: "둥글린 바깥이 투명해야 하는데 JPEG에는 투명이 없습니다. JPEG로 저장하면 네 귀퉁이가 검거나 흰색으로 남습니다.",
    },
    {
      q: "100%로 하면 정확히 원이 되나요?",
      a: "정사각형이면 완전한 원이 됩니다. 직사각형이면 양 끝이 반원인 알약 모양이 되므로, 원을 원하면 \"정사각형으로 자르기\"를 함께 켜세요.",
    },
    {
      q: "프로필 사진에 쓰려면 어떻게 하나요?",
      a: "\"정사각형으로 자르기\"를 켜고 둥글기를 100%로 두면 됩니다. 대부분의 서비스가 알아서 원형으로 잘라 보여주지만, 미리 잘라 두면 어디서나 같게 보입니다.",
    },
  ],
  "image/split": [
    {
      q: "조각을 다시 붙이면 원본이 되나요?",
      a: "크기는 정확히 같아집니다. 나누어떨어지지 않을 때 남는 픽셀을 앞쪽 조각에 한 픽셀씩 나눠 주기 때문입니다. 버리면 작아지고 마지막 조각에 몰아주면 그 조각만 커집니다.",
    },
    {
      q: "인스타그램에 올리는 차례는?",
      a: "화면의 번호가 왼쪽 위부터 오른쪽으로 매겨집니다. 인스타그램은 나중에 올린 것이 왼쪽에 오므로 번호가 큰 것부터 올리면 화면과 같은 배치가 됩니다.",
    },
    {
      q: "한 번에 다 저장하면 파일이 여러 개 받아지나요?",
      a: "조각마다 한 파일씩 내려받습니다. 브라우저가 여러 파일 내려받기를 막고 있으면 허용해 주거나 조각을 하나씩 눌러 저장하세요.",
    },
  ],
  "image/favicon": [
    {
      q: "왜 이 여섯 가지 크기인가요?",
      a: "각 플랫폼이 실제로 찾는 크기입니다. 16·32는 브라우저 탭, 48은 바로가기, 180은 iOS 홈 화면(apple-touch-icon), 192·512는 안드로이드 웹 앱 매니페스트가 씁니다.",
    },
    {
      q: ".ico 파일은 안 만드나요?",
      a: "만들지 않습니다. 요즘 브라우저는 PNG 파비콘을 그대로 읽고, 함께 내주는 head 코드도 PNG를 가리킵니다. 아주 오래된 브라우저까지 챙겨야 한다면 별도 변환이 필요합니다.",
    },
    {
      q: "정사각형이 아닌 그림을 올리면요?",
      a: "가운데를 기준으로 짧은 변에 맞춰 정사각형으로 자릅니다. 늘려서 맞추면 그림이 찌그러집니다.",
    },
    {
      q: "함께 나오는 코드는 어디에 넣나요?",
      a: "head 코드는 HTML의 <head> 안에, 매니페스트 내용은 site.webmanifest 파일로 저장해 사이트 최상위에 둡니다. 만든 PNG들도 같은 최상위에 두면 됩니다.",
    },
  ],
  'image/rotate': [
    {
  ...
  "text/mask": [
    {
      q: "가린 글을 어디로 보내나요?",
      a: "보내지 않습니다. 브라우저 안에서만 처리하고 서버로 올리지 않으므로, 인터넷이 끊긴 상태에서도 그대로 동작합니다.",
    },
    {
      q: "왜 전부 가리지 않고 뒷자리를 남기나요?",
      a: "전부 가리면 어느 기록이었는지 알 수 없어 확인용으로 쓸 수 없기 때문입니다. 전화번호는 뒤 네 자리, 이메일은 도메인, 카드번호는 앞뒤 네 자리를 남깁니다. 다 가리고 싶다면 그 항목을 끄고 직접 지우는 편이 안전합니다.",
    },
    {
      q: "이름이 아닌 낱말까지 가려집니다.",
      a: "이름 규칙이 \"한글 두~네 글자\"라 인사말이나 일반 낱말도 걸릴 수 있습니다. 안녕하세요·감사합니다·주식회사처럼 흔한 말은 빼 두었지만 모든 경우를 담을 수는 없으니, 글에 이름이 없다면 이름 항목을 꺼 두세요.",
    },
    {
      q: "주민등록번호는 왜 앞 일곱 자리가 남나요?",
      a: "생년월일과 성별 자리는 남기고 뒤 여섯 자리만 가립니다. 개인을 특정하는 것은 뒷자리라, 이 정도가 확인과 보호가 함께 되는 선입니다. 더 가리려면 카드번호처럼 앞자리도 지워야 합니다.",
    },
  ],
  "text/wrap": [
    {
      q: "\"끊긴 줄 이어 붙이기\"를 하면 문단이 다 합쳐지나요?",
      a: "아닙니다. 빈 줄을 문단의 경계로 봅니다. 문단 사이에 빈 줄이 있으면 그대로 남고 문단 안의 줄바꿈만 사라집니다. 빈 줄 없이 붙어 있는 글은 한 문단으로 봅니다.",
    },
    {
      q: "낱말을 안 자른다고 했는데 잘렸습니다.",
      a: "한국어처럼 낱말 사이 공백이 드문 글은 접을 자리가 없을 수 있습니다. 그럴 때는 폭을 넘기는 대신 그냥 자릅니다 — 안 그러면 한 줄이 통째로 남아 접은 의미가 없어집니다.",
    },
    {
      q: "접었다가 다시 펴면 원래대로 돌아오나요?",
      a: "문단 구조는 그대로 돌아옵니다. 다만 원래 글에 있던 줄 안의 여러 칸 공백은 한 칸으로 줄어듭니다.",
    },
  ],
  "text/table": [
    {
      q: "엑셀에서 복사하면 무엇으로 나뉘나요?",
      a: "탭입니다. \"알아서\"로 두면 탭·쉼표·두 칸 이상 공백 중에서 줄마다 개수가 고른 것을 고릅니다. 쉼표가 한 줄에만 있으면 그것은 구분자가 아니라 글의 일부로 봅니다.",
    },
    {
      q: "줄마다 칸 수가 다르면 어떻게 되나요?",
      a: "가장 많은 칸 수에 맞춰 짧은 줄을 빈칸으로 채웁니다. 안 그러면 마크다운 표가 어긋나 보입니다.",
    },
    {
      q: "칸 안에 세로줄(|)이 있으면요?",
      a: "앞에 역슬래시를 붙여 벗겨 냅니다. 그대로 두면 그 자리에서 칸이 나뉘어 표가 깨집니다.",
    },
    {
      q: "\"칸 너비 맞추기\"는 무엇이 달라지나요?",
      a: "만들어진 마크다운 소스 자체의 줄 길이를 맞춰 여백을 채웁니다. 화면에 보이는 표는 같지만, 소스를 직접 볼 일이 많다면 훨씬 읽기 좋습니다.",
    },
  ],
  "text/slug": [
    {
      q: "왜 한글을 로마자로 바꾸나요?",
      a: "주소에 한글을 그대로 두면 브라우저가 %EC%95%88 같은 형태로 바꿔 버려 링크가 길어지고 읽기 어려워집니다. 로마자로 옮기면 주소만 보고도 무슨 글인지 알 수 있습니다.",
    },
    {
      q: "로마자 표기가 여권과 다릅니다.",
      a: "여기서는 주소에 쓰기 좋은 짧고 헷갈리지 않는 표기를 씁니다. 여권에 쓸 이름 표기는 /text/romanize의 영문 이름 변환을 쓰세요.",
    },
    {
      q: "길이를 제한하면 낱말이 잘리나요?",
      a: "아닙니다. 자른 자리가 낱말 중간이면 그 낱말을 통째로 버리고 앞의 낱말까지만 남깁니다.",
    },
  ],
  "text/reverse": [
    {
      q: "이모지가 깨지지 않나요?",
      a: "깨지지 않습니다. 글자를 코드포인트 단위로 다루기 때문에 이모지 하나를 하나로 셉니다. 흔히 쓰는 방식으로 쪼개면 이모지가 두 조각으로 갈라져 알아볼 수 없게 됩니다.",
    },
    {
      q: "두 번 뒤집으면 원래대로 돌아오나요?",
      a: "세 단위 모두 돌아옵니다. 낱말 단위는 공백까지 함께 뒤집으므로 여러 칸 공백도 그대로 살아납니다.",
    },
    {
      q: "여러 줄을 넣으면 어떻게 되나요?",
      a: "글자·낱말 단위는 줄마다 따로 뒤집어 줄 차례는 그대로 둡니다. 줄 단위를 고르면 줄 차례만 뒤집고 줄 안은 건드리지 않습니다.",
    },
  ],
  "text/vertical": [
    {
      q: "여러 줄을 넣으면 어떻게 되나요?",
      a: "줄마다 한 세로줄이 됩니다. 첫 줄이 왼쪽에 서고, \"오른쪽에서 왼쪽으로\"를 켜면 전통 세로쓰기처럼 첫 줄이 오른쪽에 섭니다.",
    },
    {
      q: "줄 길이가 다르면 정렬이 어긋나지 않나요?",
      a: "짧은 줄의 빈자리를 공백으로 채워 세로 정렬을 맞춥니다. 줄 끝의 남는 공백은 지우므로 복사해도 지저분해지지 않습니다.",
    },
    {
      q: "붙여 넣으면 정렬이 흐트러집니다.",
      a: "글자 폭이 같은 고정폭 글꼴에서만 세로줄이 맞습니다. 한글과 영문이 섞여 있으면 폭이 달라 어긋나 보일 수 있습니다.",
    },
  ],
  "text/qr": [
    {
      q: "만든 QR 코드에 유효기간이 있나요?",
      a: "없습니다. 내용이 QR 안에 그대로 들어 있어 중간에 거치는 서버가 없습니다. 짧은 주소로 바꿔 주는 서비스로 만든 QR은 그 서비스가 문을 닫으면 죽지만, 여기서 만든 것은 그림이 남아 있는 한 계속 읽힙니다.",
    },
    {
      q: "와이파이 비밀번호를 넣어도 괜찮나요?",
      a: "인코딩을 브라우저 안에서 하므로 입력한 값이 서버로 나가지 않습니다. 다만 만들어진 QR 자체에는 비밀번호가 그대로 들어 있으니, 아무나 볼 수 있는 곳에 붙이는 것은 비밀번호를 적어 붙이는 것과 같습니다.",
    },
    {
      q: "오류정정 등급은 어느 것을 고르면 되나요?",
      a: "화면으로 보여 줄 것이면 M, 인쇄해서 붙이거나 스티커로 쓸 것이면 Q나 H가 좋습니다. 등급을 올리면 찢기거나 가려져도 읽히지만 같은 내용이 더 큰 QR이 됩니다. 가운데에 로고를 얹을 계획이라면 H로 만드세요.",
    },
    {
      q: "\"너무 길다\"고 나오는데 그냥 만들어 주면 안 되나요?",
      a: "잘라서 만들면 화면에는 멀쩡한 QR이 나오지만 스캐너는 아무것도 못 읽습니다. 인쇄해서 붙인 뒤에야 알게 되는 고장이라 만들지 않습니다. 오류정정 등급을 낮추거나, 긴 내용은 주소 하나만 담고 나머지는 그 페이지에 두세요.",
    },
    {
      q: "PNG와 SVG 중 무엇을 받아야 하나요?",
      a: "인쇄물·현수막처럼 크게 쓸 것이면 SVG입니다. PNG는 늘리면 칸 경계가 흐려지고, QR은 그 경계가 흐려지면 못 읽습니다. 메신저나 문서에 바로 붙일 때는 PNG가 편합니다.",
    },
  ],
  'text/dedupe': [
    {
  ...
  "game/stroop": [
    {
      q: "왜 글자를 읽으면 안 되나요?",
      a: "읽는 것은 훈련된 자동 반응이라 막을 수 없습니다. 스트룹 효과는 바로 그 자동 반응을 억누르는 데 드는 비용을 재는 것입니다. 그래서 글자와 색이 다를 때 느려지는 정도가 곧 억제 능력의 지표가 됩니다.",
    },
    {
      q: "글자와 색이 같은 문제도 나옵니다.",
      a: "일부러 3할쯤 섞었습니다. 전부 어긋나 있으면 \"글자를 무시하라\"가 아니라 \"글자의 반대를 고르라\"가 되어 오히려 쉬워집니다.",
    },
    {
      q: "색약이 있으면 불리하지 않나요?",
      a: "다섯 색을 뚜렷이 다른 색으로 골랐지만, 색 구분 자체가 어려우면 결과가 낮게 나올 수 있습니다. 그 경우 이 점수는 억제 능력이 아니라 색 구분을 잰 것입니다.",
    },
  ],
  "game/dot-count": [
    {
      q: "세면 안 되나요?",
      a: "셀 수는 있지만 단계가 오르면 시간이 짧아져 곧 셀 수 없게 됩니다. 사람이 한눈에 세는 한계는 대략 네 개까지이고, 그 위부터는 어림이 됩니다.",
    },
    {
      q: "점수는 어떻게 매기나요?",
      a: "오차를 정답 대비 비율로 잽니다. 쉰 개에서 둘 틀린 것과 다섯 개에서 둘 틀린 것은 다른 일이라, 절대 오차로 재면 뒷단계가 지나치게 후해집니다.",
    },
    {
      q: "보이는 시간이 계속 줄어드나요?",
      a: "320밀리초에서 멈춥니다. 그보다 짧으면 사람 눈이 아니라 화면 갱신 속도를 재게 됩니다.",
    },
  ],
  "game/nback": [
    {
      q: "N-back이 무엇을 재나요?",
      a: "작업기억입니다. 방금 것들을 머릿속에 붙들어 두면서 계속 새것으로 갈아 끼워야 하는데, 그 용량과 갱신 능력이 곧 작업기억입니다.",
    },
    {
      q: "전부 누르면 점수가 높지 않나요?",
      a: "높지 않습니다. 잘못 누른 것을 맞힌 것에서 빼기 때문입니다. 안 빼면 전부 누르는 것이 최적 전략이 되어 게임이 성립하지 않습니다.",
    },
    {
      q: "처음 몇 개는 왜 안 세나요?",
      a: "n칸 앞이 없어서 비교할 대상이 없기 때문입니다. 2-back이면 첫 두 개가 채점에서 빠집니다.",
    },
  ],
  "game/rotation": [
    {
      q: "\"다른\" 문제는 어떻게 만드나요?",
      a: "좌우로 뒤집어 만듭니다. 아무 도형이나 갖다 대면 칸 수나 생김새가 대놓고 달라 돌려 볼 필요도 없이 답이 보입니다. 거울상은 칸 수가 같고 모양도 비슷해서 실제로 머릿속에서 돌려 봐야 합니다.",
    },
    {
      q: "가끔 뒤집은 것도 같아 보입니다.",
      a: "대칭 도형은 거울상이 회전으로도 같아집니다. 그러면 \"다르다\"가 거짓이 되므로 그런 도형은 문제로 내지 않습니다.",
    },
    {
      q: "실제 심적 회전 검사와 같나요?",
      a: "원리는 같지만 훨씬 간단합니다. 학술 검사는 입체 도형을 쓰고 각도도 여러 단계로 나눕니다.",
    },
  ],
  "game/beat": [
    {
      q: "왜 소리가 중간에 멈추나요?",
      a: "소리를 들으며 따라 치는 것은 반응이고, 소리 없이 이어가는 것이 박자 감각입니다. 재려는 것은 뒤쪽입니다.",
    },
    {
      q: "평균 오차가 작은데 점수가 낮습니다.",
      a: "고름도 함께 보기 때문입니다. 한 번은 100 빠르고 한 번은 100 늦으면 평균은 0에 가깝지만 박자는 엉망입니다.",
    },
    {
      q: "조금씩 늦는데 감점이 큽니까?",
      a: "25밀리초까지는 감점하지 않습니다. 사람이 알아채지 못하는 차이이기 때문입니다. 그 위로도 일정하게 늦는 것은 들쭉날쭉한 것보다 적게 깎입니다.",
    },
  ],
  "game/peripheral": [
    {
      q: "눈을 움직이면 안 되나요?",
      a: "움직이면 주변시야가 아니라 눈 움직임 속도를 재게 됩니다. 시간 안에 못 누르면 끝나도록 해 눈을 돌려 찾을 틈을 없앴습니다.",
    },
    {
      q: "표적이 가운데에는 안 나오나요?",
      a: "나오지 않습니다. 가운데를 비운 고리 안에만 나타나고, 단계가 오를수록 고리가 바깥으로 갑니다.",
    },
    {
      q: "휴대폰과 컴퓨터 결과가 다릅니다.",
      a: "화면과 눈 사이의 거리가 다르면 같은 픽셀이라도 시야에서 차지하는 각도가 달라집니다. 같은 기기·같은 거리에서 잰 기록끼리 견주는 것이 맞습니다.",
    },
  ],
  "game/minesweeper": [
    {
      q: "첫 클릭에 지뢰를 밟을 수 있나요?",
      a: "없습니다. 지뢰는 첫 클릭을 누른 뒤에 놓이고, 누른 칸과 그 이웃 여덟 칸은 비워 둡니다. 그래서 첫 칸은 언제나 0이 되어 넓게 열리고, 첫 수부터 추론으로 시작할 수 있습니다.",
    },
    {
      q: "휴대폰에서는 깃발을 어떻게 꽂나요?",
      a: "칸을 길게 누르면 꽂힙니다. 여러 개를 잇달아 꽂을 때는 위의 깃발 단추를 켜 두면 그냥 눌러서 꽂을 수 있고, 다시 열기로 되돌리면 됩니다.",
    },
    {
      q: "3BV가 무엇인가요?",
      a: "그 판을 깃발 없이 푸는 데 필요한 최소 클릭 수입니다. 같은 30초라도 3BV 150짜리 판과 80짜리 판은 전혀 다른 일이어서, 초만 재면 쉬운 판을 뽑은 사람이 이깁니다. 그래서 시간과 함께 봅니다.",
    },
    {
      q: "고급 판이 화면을 넘어갑니다.",
      a: "고급은 가로 30칸이라 좁은 화면에서는 판만 좌우로 밀립니다. 판 영역 안에서만 밀리므로 문서 전체가 흔들리지는 않습니다.",
    },
    {
      q: "기록은 어디에 남나요?",
      a: "이 기기의 브라우저에만 남고 서버로 올라가지 않습니다. 초급·중급·고급의 기록을 따로 두므로 판을 바꿔도 기록이 섞이지 않습니다.",
    },
  ],
  'game/typing': [
    {
  ...
  'game/sliding': [
    {
      q: '아무리 옮겨도 안 맞춰지는 판이 있나요?',
      a: '이 퍼즐은 늘어놓는 방법의 절반이 완성될 수 없습니다 — 완성판에서 두 칸만 맞바꾼 판이 그렇습니다. 그래서 섞을 때마다 짝치환 개수와 빈 칸의 줄을 셈해 풀 수 있는 판인지 확인하고, 아니면 두 칸을 맞바꿔 고쳐서 내놓습니다. 여기서 나오는 판은 모두 풀립니다.',
    },
    {
      q: '한 번에 여러 칸을 옮길 수 있나요?',
      a: '빈 칸과 같은 줄이나 같은 칸에 있는 먼 칸을 누르면 사이에 있는 칸이 한꺼번에 밀립니다. 움직인 수는 밀린 칸만큼 늘고, 되돌리기는 한 칸씩 되짚습니다.',
    },
    {
      q: '남은 거리는 무엇을 재는 값인가요?',
      a: '칸마다 제자리까지 가야 하는 걸음을 모두 더한 값(맨해튼 거리)입니다. 한 번 옮길 때 1만 바뀌므로 남은 거리보다 적게 옮겨서는 끝낼 수 없습니다. 최소 움직임 자체가 아니라 그것의 하한이라, 실제로는 그보다 더 걸립니다.',
    },
    {
      q: '최고 기록은 어떻게 남나요?',
      a: '다 맞춘 시간을 판 크기(3×3·4×4·5×5)마다 따로 저장합니다. 이 기기의 브라우저에만 남고 서버로 올라가지 않습니다.',
    },
  ],
  'game/2048': [
    {
      q: '4·4·4·4를 밀면 16이 되나요?',
      a: '아니요, 8·8이 됩니다. 한 번 밀 때 같은 칸은 한 번만 합쳐지기 때문입니다. 합쳐서 생긴 8이 옆의 8과 붙는 것은 다음 밀기부터입니다.',
    },
    {
      q: '2048을 만들면 끝나나요?',
      a: '아닙니다. 2048이 나오면 알려만 주고, 계속하기를 누르면 그대로 이어서 4096을 노릴 수 있습니다. 점수도 계속 쌓입니다.',
    },
    {
      q: '휴대폰에서는 어떻게 움직이나요?',
      a: '판 위에서 원하는 방향으로 손가락을 밀면 됩니다. 판 위에서는 페이지가 함께 스크롤되지 않고, 컴퓨터에서는 화살표 키나 WASD로도 움직입니다.',
    },
    {
      q: '점수는 어떻게 매겨지나요?',
      a: '합쳐서 생긴 값을 그대로 더합니다. 4가 만들어지면 4점, 8이 만들어지면 8점입니다. 그래서 큰 수를 만들수록 점수가 급하게 오릅니다. 최고 점수는 이 기기의 브라우저에만 남습니다.',
    },
  ],
  'game/sudoku': [
    {
      q: '답이 여러 개인 문제가 나올 수 있나요?',
      a: '없습니다. 문제는 완성판에서 한 칸씩 지우면서 만드는데, 지울 때마다 답이 하나로 남는지 세어 보고 둘이 되면 그 칸을 되돌립니다. 그래서 어느 판이든 답이 정확히 하나입니다.',
    },
    {
      q: '난이도는 빈칸 수로 정하나요?',
      a: '아닙니다. 푸는 데 필요한 기법으로 정합니다. 쉬움은 들어갈 수가 하나뿐인 칸만 따라가면 끝까지 풀리고, 보통은 줄이나 상자에서 그 수가 들어갈 자리가 하나뿐인 것을 봐야 하며, 어려움은 그 둘로도 막히는 자리가 있습니다. 빈칸 수는 그 결과로 정해집니다.',
    },
    {
      q: '힌트를 누르면 답을 채워 주나요?',
      a: '채우지 않고 칸 하나와 그 까닭만 알려줍니다 — "이 칸에는 7만 들어간다" 또는 "이 줄에서 7이 들어갈 자리는 여기뿐이다"처럼요. 같은 꼴을 다음에는 혼자 찾을 수 있어야 힌트가 쓸모 있기 때문입니다.',
    },
    {
      q: '같은 문제를 다시 풀 수 있나요?',
      a: '네. 판 아래에 문제 번호가 적혀 있고, 주소 뒤에 ?seed=번호를 붙여 들어오면 같은 문제가 그대로 나옵니다. 같은 번호는 늘 같은 판입니다.',
    },
    {
      q: '기록은 어디에 남나요?',
      a: '이 기기의 브라우저에만 남고, 난이도마다 따로 남습니다. 쉬움 3분과 어려움 20분을 한 칸에 담으면 어려움 기록이 영원히 안 남기 때문입니다.',
    },
  ],
