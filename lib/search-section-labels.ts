...
export const SECTION_ORDER = ['calculator', 'rate', 'body', 'geometry', 'cmd', 'shortcut', 'emoji', 'error', 'convert', 'color', 'time', 'image', 'sound', 'food', 'game', 'device', 'text', 'checklist', 'quiz', 'test', 'generator', 'fortune', 'snap'];
