...
export const RATE_META = {
  ko: {
    section: '비율 계산',
    hubTitle: '비율·환산 계산기',
    hubLead: '할인율·부가세·이자·농도까지 공식 하나로 끝나는 계산 {n}가지',
    hubNotice: '📐 값을 넣으면 바로 계산됩니다. 계산식도 함께 보여줍니다.',
    footNote: '세율과 이자 계산 방식은 나라와 상품에 따라 다릅니다. 실제 거래는 계약 조건을 확인하세요.',
    metaTitle: '비율 계산기 — 할인율·부가세·이자·농도 {n}종',
    metaDesc:
      '할인율, 삼중 할인, N+1 실질 할인, 부가세, 관세, 실효세율, 증감률, 퍼센트포인트, 백분위, 복리, 대출 한도, 중도상환, 농도와 희석까지 {n}가지 비율 계산을 한 곳에서. 계산식·입력 설명·값별 결과 표를 함께 봅니다.',
  },
  en: {
    ...
    metaTitle: 'Percentage Calculators — {n} Rate & Ratio Tools',
    metaDesc:
      'Discounts, stacked discounts, buy-one-get-one, VAT, import duty, effective tax rate, percent change, percentage points, percentiles, compound interest, borrowing limits, dilution and blending — {n} rate calculators, each with the formula, an input guide and a reference table.',
  },
} as const;
...
export const RATE_META_INTL: Partial<Record<FormulaLang, SectionMeta>> = {
  es: {
    ...
    metaTitle: 'Calculadora de porcentajes — {n} herramientas de proporción',
    metaDesc: 'Descuentos, descuentos acumulados, 3x2, IVA, aranceles, tipo efectivo, variación porcentual, puntos porcentuales, percentiles, interés compuesto, capacidad de endeudamiento, diluciones y mezclas: {n} calculadoras, cada una con su fórmula, una guía de los datos y una tabla de referencia.',
  },
  'pt-br': {
    ...
    metaTitle: 'Calculadora de porcentagem — {n} ferramentas de proporção',
    metaDesc: 'Descontos, descontos acumulados, leve 3 pague 2, impostos, imposto de importação, alíquota efetiva, variação percentual, pontos percentuais, percentis, juros compostos, limite de crédito, diluição e mistura: {n} calculadoras, cada uma com a fórmula, um guia dos campos e uma tabela de referência.',
  },
  ja: {
    section: '割合の計算',
    hubTitle: '割合・比率の計算機',
    hubLead: '割引・税・利息・濃度まで、公式ひとつで終わる計算{n}種',
    hubNotice: '📐 値を入れるとすぐ計算します。計算式も一緒に見られます。',
    footNote: '税率と利息の計算方法は国と商品によって違います。実際の取引では契約条件を確かめてください。',
    metaTitle: '割合の計算機 — 割引・税・利息・濃度{n}種',
    metaDesc: '割引率、重ねがけ割引、2個買うと1個無料、消費税、関税、実効税率、変化率、パーセントポイント、パーセンタイル、複利、借入可能額、繰上返済、濃度と希釈まで{n}種類の割合計算。計算式・入力の説明・値ごとの結果表も一緒に見られます。',
  },
  de: {
    ...
    metaTitle: 'Prozentrechner — {n} Werkzeuge für Anteile und Verhältnisse',
    metaDesc: 'Rabatte, gestapelte Rabatte, 3 für 2, Mehrwertsteuer, Zoll, effektiver Steuersatz, prozentuale Veränderung, Prozentpunkte, Perzentile, Zinseszins, Kreditrahmen, Verdünnen und Mischen — {n} Rechner, jeder mit Formel, Eingabehilfe und Referenztabelle.',
  },
  fr: {
    ...
    metaTitle: 'Calculatrice de pourcentage — {n} outils de rapport',
    metaDesc: 'Remises, remises cumulées, 3 pour 2, TVA, droits de douane, taux effectif, variation en pourcentage, points de pourcentage, centiles, intérêts composés, capacité d’emprunt, dilution et mélange : {n} calculatrices, chacune avec sa formule, un guide de saisie et un tableau de référence.',
  },
  hi: {
    ...
    metaTitle: 'प्रतिशत कैलकुलेटर — अनुपात के {n} औज़ार',
    metaDesc: 'छूट, एक पर एक छूट, तीन पर दो, GST, सीमा शुल्क, असली कर दर, प्रतिशत बदलाव, प्रतिशत अंक, पर्सेंटाइल, चक्रवृद्धि ब्याज, कर्ज़ की सीमा, तनुकरण और मिश्रण — {n} कैलकुलेटर, हर एक के साथ सूत्र, इनपुट की व्याख्या और मान के हिसाब से परिणाम की सारणी।',
  },
  'zh-hans': {
    section: '比例计算',
    hubTitle: '百分比与比例计算器',
    hubLead: '折扣、税、利息、浓度，一个公式就能算完的{n}种',
    hubNotice: '📐 边填边算，每一页都把公式摆出来。',
    footNote: '税率和利息的算法因国家和产品而异。真要办业务时，以合同条款为准。',
    metaTitle: '百分比计算器 — 折扣·税·利息·浓度 {n}种',
    metaDesc: '折扣率、叠加折扣、买二送一、增值税、关税、实际税率、变化率、百分点、百分位、复利、可贷额度、提前还款、稀释与配比，共{n}种比例计算。每一种都附公式、填写说明和不同取值的结果表。',
  },
  'zh-hant': {
    section: '比例計算',
    hubTitle: '百分比與比例計算器',
    hubLead: '折扣、稅、利息、濃度，一個公式就能算完的{n}種',
    hubNotice: '📐 邊填邊算，每一頁都把公式擺出來。',
    footNote: '稅率和利息的算法因國家和產品而異。真要辦業務時，以合約條款為準。',
    metaTitle: '百分比計算器 — 折扣·稅·利息·濃度 {n}種',
    metaDesc: '折扣率、疊加折扣、買二送一、加值稅、關稅、實際稅率、變化率、百分點、百分位、複利、可貸額度、提前還款、稀釋與配比，共{n}種比例計算。每一種都附公式、填寫說明和不同取值的結果表。',
  },
};
