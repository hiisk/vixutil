...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '이슬점 210칸 — 습도 60%가 늘 같지 않은 이유',
    '210 dew points — why 60% humidity is never the same twice',
    '210 puntos de rocío — por qué el 60% de humedad nunca es igual',
    '210 pontos de orvalho — por que 60% de umidade nunca é igual',
    '露点189マス — 湿度60%が同じでない理由',
    '210 Taupunkte — warum 60 % Luftfeuchte nie dasselbe heißt',
    '210 points de rosée — pourquoi 60 % d’humidité n’est jamais pareil',
    '189 ओसांक — 60% आर्द्रता हर बार एक जैसी क्यों नहीं',
    '210 个露点 — 为什么同样 60% 的湿度感觉不同',
    '210 個露點 — 為什麼同樣 60% 的濕度感覺不同',
  ),

  hubLead: T(
    '기온 21가지와 습도 10가지가 만나는 칸마다 이슬점을 계산했습니다. 30도의 60%는 10도의 60%보다 물을 세 배 넘게 품고 있습니다.',
    'A dew point for every meeting of 21 temperatures and 10 humidities. Air at 30 °C and 60% holds more than three times the water of 10 °C at the same 60%.',
    'Un punto de rocío para cada cruce de 21 temperaturas y 10 humedades. El aire a 30 °C con 60% lleva más del triple de agua que a 10 °C con el mismo 60%.',
    'Um ponto de orvalho para cada cruzamento de 21 temperaturas e 10 umidades. O ar a 30 °C com 60% carrega mais do triplo de água que a 10 °C com os mesmos 60%.',
    '気温21通りと湿度9通りが出会う各マスの露点を計算しました。30度の60%は10度の60%より3倍以上の水を含んでいます。',
    'Für jede Begegnung von 21 Temperaturen und 10 Feuchtewerten ein Taupunkt. Luft bei 30 °C und 60 % trägt über dreimal so viel Wasser wie 10 °C bei denselben 60 %.',
    'Un point de rosée pour chaque croisement de 21 températures et 10 humidités. L’air à 30 °C et 60 % contient plus du triple d’eau qu’à 10 °C au même 60 %.',
    '21 तापमान और 9 आर्द्रताओं के हर मेल का ओसांक। 30 °C पर 60% हवा में 10 °C के उसी 60% से तीन गुना से अधिक पानी होता है।',
    '21 种气温与 10 种湿度交汇的每一格都算出露点。30 度的 60% 所含水汽是 10 度 60% 的三倍多。',
    '21 種氣溫與 10 種濕度交匯的每一格都算出露點。30 度的 60% 所含水汽是 10 度 60% 的三倍多。',
  ),
  ...
  hubMetaTitle: T(
    '이슬점표 — 기온과 습도로 보는 210칸',
    'Dew point chart — 210 cells of temperature and humidity',
    'Tabla de punto de rocío — 210 casillas de temperatura y humedad',
    'Tabela de ponto de orvalho — 210 células de temperatura e umidade',
    '露点表 — 気温と湿度で見る189マス',
    'Taupunkt-Tabelle — 210 Felder aus Temperatur und Feuchte',
    'Table du point de rosée — 210 cases de température et d’humidité',
