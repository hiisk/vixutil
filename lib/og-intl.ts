...
const CARDS: Record<string, Card> = {
  ...
  'calculator/en': { icon: '🧮', eyebrow: 'Calculators', title: 'Free online calculators', desc: 'Health · money · dates · units · developer tools', from: '#3b82f6', to: '#4f46e5' },
  'calculator/es': { icon: '🧮', eyebrow: 'Calculators', title: 'Calculadoras en línea gratis', desc: 'Salud · dinero · fechas · unidades · programación', from: '#3b82f6', to: '#4f46e5' },
  'calculator/pt-br': { icon: '🧮', eyebrow: 'Calculators', title: 'Calculadoras online grátis', desc: 'Saúde · dinheiro · datas · unidades · desenvolvimento', from: '#3b82f6', to: '#4f46e5' },
  'calculator/ja': { icon: '🧮', eyebrow: 'Calculators', title: '無料のオンライン計算機', desc: '健康 · お金 · 日付 · 単位 · 開発者向け', from: '#3b82f6', to: '#4f46e5' },
  'calculator/de': { icon: '🧮', eyebrow: 'Calculators', title: 'Kostenlose Online-Rechner', desc: 'Gesundheit · Geld · Datum · Einheiten · Entwickler', from: '#3b82f6', to: '#4f46e5' },
  'calculator/fr': { icon: '🧮', eyebrow: 'Calculators', title: 'Calculatrices en ligne gratuites', desc: 'Santé · argent · dates · unités · développeurs', from: '#3b82f6', to: '#4f46e5' },
  'calculator/hi': { icon: '🧮', eyebrow: 'Calculators', title: 'मुफ़्त ऑनलाइन कैलकुलेटर', desc: 'सेहत · पैसा · तारीख़ · इकाइयाँ · डेवलपर', from: '#3b82f6', to: '#4f46e5' },
  'calculator/zh-hans': { icon: '🧮', eyebrow: 'Calculators', title: '免费在线计算器', desc: '健康 · 理财 · 日期 · 单位 · 开发者工具', from: '#3b82f6', to: '#4f46e5' },
  'calculator/zh-hant': { icon: '🧮', eyebrow: 'Calculators', title: '免費線上計算機', desc: '健康 · 理財 · 日期 · 單位 · 開發者工具', from: '#3b82f6', to: '#4f46e5' },
