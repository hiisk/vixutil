...
const zh: FoodUI = {
  home: '首页',
  section: '食材重量换算',
  hubTitle: '125 种食材的杯、勺重量换算',
  hubLead: '一杯面粉是 125 克，一杯糖是 200 克。每种食材的重量都不一样，这里用美式杯、韩式杯、大勺、小勺一次列清楚',
  cupUs: '美式杯（240ml）',
  cupMetric: '韩日杯（200ml）',
  cupUk: '英式杯（284ml）',
  tbsp: '大勺（15ml）',
  ...
  how: [
    ...
    '做烘焙用秤准得多，因为面团的含水比例就差在这几克上。',
    '大勺按 15ml、小勺按 5ml 算。吃饭用的汤匙比这大，所以请用量匙。',
  ],
  faqTitle: '常见问题',
  categoryLabel: CAT('粉类', '糖类', '谷物', '乳制品', '油脂', '坚果与籽', '豆类', '调味与香料', '液体', '蔬菜', '其他'),
  hubMetaTitle: '食材重量换算 125 种 — 一杯、一勺是多少克',
  hubMetaDesc: '面粉、糖、黄油、大米、蜂蜜等 125 种食材，一杯、一大勺、一小勺各是多少克，按美式杯（240ml）和韩式杯（200ml）两个标准一并列出，也算出 100 克等于几杯。',
  metaTitle: (name, grams) => `一杯${name} ${grams} 克 — 重量换算`,
  metaDesc: (name, f) =>
    `一杯${name}，按美式杯（240ml）是 ${f.grams.cupUs} 克，按韩式杯（200ml）是 ${f.grams.cupMetric} 克。一大勺 ${f.grams.tbsp} 克，一小勺 ${f.grams.tsp} 克；100 克约合 ${f.cupsPer100g} 杯（${f.mlPer100g}ml）。`,
  hubFaq: [
    {
      q: '同样是一杯，为什么各种食材的重量不一样？',
      a: '杯量的是体积，而每种食材的密度不同。面粉颗粒之间空气多，一杯只有 125 克；蜂蜜没有空隙，一杯有 340 克。体积一样，重量能差近三倍。',
    },
    {
      q: '该按哪个国家的杯来看？',
      a: '看食谱是哪儿来的。美国和加拿大的食谱是 240ml，韩国和日本是 200ml，老一点的英式食谱是 284ml。要是不知道出处，照本页的克数来称最稳妥。',
    },
    {
      q: '为什么都说烘焙要用秤？',
      a: '粉怎么装进杯子，同样一杯能从 120 克到 150 克。面团的含水比例这么一晃，面包就发不起来、饼干就摊开了。用秤，这个变数就没了。',
    },
    {
      q: '大勺和吃饭的汤匙一样吗？',
      a: '不一样。量匙的大勺定为 15ml、小勺 5ml，而吃饭的汤匙从 10ml 到 18ml 都有。调味太咸或太淡，多半就是这个原因。',
    },
  ],
  itemFaq: (name, f) => [
    {
      q: `一杯${name}是多少克？`,
      a: `按美式杯（240ml）是 ${f.grams.cupUs} 克，按韩日杯（200ml）是 ${f.grams.cupMetric} 克。都是舀起来再刮平的状态。`,
    },
    {
      q: `一大勺和一小勺${name}各是多少克？`,
      a: `大勺（15ml）是 ${f.grams.tbsp} 克，小勺（5ml）是 ${f.grams.tsp} 克。按量匙算，吃饭的汤匙比这个大。`,
    },
    {
      q: `100 克${name}是几杯？`,
      a: `约 ${f.cupsPer100g} 杯（按美式杯），换成体积是 ${f.mlPer100g}ml。食谱写的是克而手边没有秤时，用这个值。`,
    },
    {
      q: '为什么称重更好？',
      a: `${name}每升 ${f.gPerL} 克。装的手法一变，同一个杯子里的量就跟着变，所以要求精准的面团，用秤能少失败很多。`,
    },
    {
      q: '和水比是重还是轻？',
      a: f.denserThanWater
        ? `比水重（水是每升 1000 克）。所以装同样的体积，它比水更压秤。`
        : `比水轻（水是每升 1000 克）。原因是颗粒之间的空气或者脂肪，体积一样时重量比水少。`,
    },
  ],
};
...
const tw: FoodUI = {
  home: '首頁',
  section: '食材重量換算',
  hubTitle: '125 種食材的杯、匙重量換算',
  hubLead: '一杯麵粉是 125 公克，一杯糖是 200 公克。每種食材的重量都不一樣，這裡用美式杯、韓式杯、大匙、小匙一次列清楚',
  cupUs: '美式杯（240ml）',
  cupMetric: '韓日杯（200ml）',
  cupUk: '英式杯（284ml）',
  tbsp: '大匙（15ml）',
  ...
  how: [
    ...
    '做烘焙用秤準得多，因為麵團的含水比例就差在這幾公克上。',
    '大匙按 15ml、小匙按 5ml 算。吃飯用的湯匙比這大，所以請用量匙。',
  ],
  faqTitle: '常見問題',
  categoryLabel: CAT('粉類', '糖類', '穀物', '乳製品', '油脂', '堅果與種子', '豆類', '調味與香料', '液體', '蔬菜', '其他'),
  hubMetaTitle: '食材重量換算 125 種 — 一杯、一匙是多少公克',
  hubMetaDesc: '麵粉、糖、奶油、白米、蜂蜜等 125 種食材，一杯、一大匙、一小匙各是多少公克，按美式杯（240ml）和韓式杯（200ml）兩個標準一併列出，也算出 100 公克等於幾杯。',
  metaTitle: (name, grams) => `一杯${name} ${grams} 公克 — 重量換算`,
  metaDesc: (name, f) =>
    `一杯${name}，按美式杯（240ml）是 ${f.grams.cupUs} 公克，按韓式杯（200ml）是 ${f.grams.cupMetric} 公克。一大匙 ${f.grams.tbsp} 公克，一小匙 ${f.grams.tsp} 公克；100 公克約合 ${f.cupsPer100g} 杯（${f.mlPer100g}ml）。`,
  hubFaq: [
    {
      q: '同樣是一杯，為什麼各種食材的重量不一樣？',
      a: '杯量的是體積，而每種食材的密度不同。麵粉顆粒之間空氣多，一杯只有 125 公克；蜂蜜沒有空隙，一杯有 340 公克。體積一樣，重量能差近三倍。',
    },
    {
      q: '該按哪個國家的杯來看？',
      a: '看食譜是哪兒來的。美國和加拿大的食譜是 240ml，韓國和日本是 200ml，老一點的英式食譜是 284ml。要是不知道出處，照本頁的公克數來秤最穩妥。',
    },
    {
      q: '為什麼都說烘焙要用秤？',
      a: '粉怎麼裝進杯子，同樣一杯能從 120 公克到 150 公克。麵團的含水比例這麼一晃，麵包就發不起來、餅乾就攤開了。用秤，這個變數就沒了。',
    },
    {
      q: '大匙和吃飯的湯匙一樣嗎？',
      a: '不一樣。量匙的大匙定為 15ml、小匙 5ml，而吃飯的湯匙從 10ml 到 18ml 都有。調味太鹹或太淡，多半就是這個原因。',
    },
  ],
  itemFaq: (name, f) => [
    {
      q: `一杯${name}是多少公克？`,
      a: `按美式杯（240ml）是 ${f.grams.cupUs} 公克，按韓日杯（200ml）是 ${f.grams.cupMetric} 公克。都是舀起來再刮平的狀態。`,
    },
    {
      q: `一大匙和一小匙${name}各是多少公克？`,
      a: `大匙（15ml）是 ${f.grams.tbsp} 公克，小匙（5ml）是 ${f.grams.tsp} 公克。按量匙算，吃飯的湯匙比這個大。`,
    },
    {
      q: `100 公克${name}是幾杯？`,
      a: `約 ${f.cupsPer100g} 杯（按美式杯），換成體積是 ${f.mlPer100g}ml。食譜寫的是公克而手邊沒有秤時，用這個值。`,
    },
    {
      q: '為什麼秤重更好？',
      a: `${name}每公升 ${f.gPerL} 公克。裝的手法一變，同一個杯子裡的量就跟著變，所以要求精準的麵團，用秤能少失敗很多。`,
    },
    {
      q: '和水比是重還是輕？',
      a: f.denserThanWater
        ? `比水重（水是每公升 1000 公克）。所以裝同樣的體積，它比水更壓秤。`
        : `比水輕（水是每公升 1000 公克）。原因是顆粒之間的空氣或者脂肪，體積一樣時重量比水少。`,
    },
  ],
};

export const FOOD_UI: L<FoodUI> = { ko, en, es, pt, ja, de, fr, hi, zh, tw };

export const foodUi = (lang: Lang): FoodUI => FOOD_UI[lang];
