...
export function hubMetadata(lang: Lang8): Metadata {
  ...
  return {
    ...
    alternates: { canonical: `${prefix8(lang)}/element`, languages: alternates8('/element') },
  };
}
...
export function detailMetadata(lang: Lang8, slug: string): Metadata {
  ...
  return {
    ...
    alternates: {
      canonical: `${prefix8(lang)}/element/${slug}`,
      languages: alternates8(`/element/${slug}`),
    },
  };
}
...
export function elementCard(lang: Lang8, slug: string): ReactElement {
