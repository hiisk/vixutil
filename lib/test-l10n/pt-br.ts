...
export const TESTS_PT: Test[] = [
  {
    ...
    results: [
      ...
      { min: 13, max: 14, emoji: '🌙', title: 'Reserva silenciosa', color: 'from-indigo-500 to-violet-600',
      ...
      { min: 18, max: 30, emoji: '⚡', title: 'Movido a gente', color: 'from-amber-400 to-orange-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🫧', title: 'Absorve tudo', color: 'from-blue-500 to-indigo-700',
      ...
      { min: 13, max: 14, emoji: '🌧️', title: 'Aguenta devagar', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 17, emoji: '⛅', title: 'Firme sob carga', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '🗿', title: 'Calmo na tempestade', color: 'from-slate-600 to-slate-800',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🔍', title: 'O que delibera', color: 'from-slate-500 to-slate-700',
      ...
      { min: 13, max: 14, emoji: '⚖️', title: 'O que pondera', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 15, max: 17, emoji: '🎯', title: 'O que decide', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '⚡', title: 'O instintivo', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🎯', title: 'Trabalho profundo', color: 'from-indigo-500 to-violet-700',
      ...
      { min: 13, max: 14, emoji: '📋', title: 'Planejador constante', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 17, emoji: '🔄', title: 'Flexível e ágil', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '🔥', title: 'Rende sob pressão', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: 'Seu par teve um dia horrível. Você:', opts: [
        { text: 'Digo exatamente o que admiro nele', score: 0, k: 'words' },
        { text: 'Fico do lado sem falar muito', score: 1, k: 'time' },
        { text: 'Tiro alguma coisa do prato dele sem alarde', score: 2, k: 'acts' },
        { text: 'Levo algo de que ele gosta', score: 3, k: 'gifts' }] },
      { q: 'O que mais te faz sentir cuidado?', opts: [
        { text: 'Ouvir dito em voz alta', score: 0, k: 'words' }, { text: 'Tempo junto sem distração', score: 1, k: 'time' },
        { text: 'Alguém resolver algo por mim', score: 2, k: 'acts' }, { text: 'Um mimo bem pensado', score: 3, k: 'gifts' }] },
      { q: 'Seu instinto num aniversário de namoro:', opts: [
        { text: 'Escrever algo', score: 0, k: 'words' }, { text: 'Planejar um dia inteiro juntos', score: 1, k: 'time' },
        { text: 'Resolver algo prático que fazia falta', score: 2, k: 'acts' }, { text: 'Achar o presente certo', score: 3, k: 'gifts' }] },
      { q: 'O que mais dói num relacionamento?', opts: [
        { text: 'Nunca ouvir que está indo bem', score: 0, k: 'words' }, { text: 'Estar presente mas distraído', score: 1, k: 'time' },
        { text: 'Ficar com tudo nas costas', score: 2, k: 'acts' }, { text: 'Ser esquecido no dia que importava', score: 3, k: 'gifts' }] },
      { q: 'Um amigo está passando por algo difícil:', opts: [
        { text: 'Digo o que penso dele', score: 0, k: 'words' }, { text: 'Abro uma noite para ele', score: 1, k: 'time' },
        { text: 'Resolvo algo prático', score: 2, k: 'acts' }, { text: 'Mando alguma coisa', score: 3, k: 'gifts' }] },
      { q: 'Você mostra que sentiu falta de alguém:', opts: [
        { text: 'Falando direto', score: 0, k: 'words' }, { text: 'Abrindo espaço na agenda na hora', score: 1, k: 'time' },
        { text: 'Fazendo algo por essa pessoa', score: 2, k: 'acts' }, { text: 'Trazendo alguma coisa', score: 3, k: 'gifts' }] },
      { q: 'O elogio que mais te pega:', opts: [
        { text: 'Algo específico sobre quem eu sou', score: 0, k: 'words' }, { text: '"Eu sempre quero mais tempo com você"', score: 1, k: 'time' },
        { text: '"Você sempre dá conta de tudo"', score: 2, k: 'acts' }, { text: '"Vi isso e lembrei de você"', score: 3, k: 'gifts' }] },
      { q: 'Numa briga, o que resolve mais rápido?', opts: [
        { text: 'Ouvir o que ainda valoriza em mim', score: 0, k: 'words' }, { text: 'Sentar e conversar de verdade', score: 1, k: 'time' },
        { text: 'A pessoa fazer algo que mostre', score: 2, k: 'acts' }, { text: 'Um gesto que diga que ela pensou nisso', score: 3, k: 'gifts' }] },
      { q: 'Seu par vai viajar por um mês. Você:', opts: [
        { text: 'Mando mensagens longas', score: 0, k: 'words' }, { text: 'Marco chamadas religiosamente', score: 1, k: 'time' },
        { text: 'Cuido de tudo em casa para ele não se preocupar', score: 2, k: 'acts' }, { text: 'Mando coisas pelo correio', score: 3, k: 'gifts' }] },
      { q: 'O que você sentiria falta primeiro?', opts: [
        { text: 'Ouvir o que a pessoa sente', score: 0, k: 'words' }, { text: 'Tempo de verdade juntos', score: 1, k: 'time' },
        { text: 'Receber ajuda sem pedir', score: 2, k: 'acts' }, { text: 'As pequenas surpresas pensadas', score: 3, k: 'gifts' }] },
    ],
    results: [
      { min: 0, max: 0, k: 'words', emoji: '💬', title: 'Palavras', color: 'from-sky-500 to-blue-600',
      ...
      { min: 0, max: 0, k: 'time', emoji: '⏳', title: 'Tempo', color: 'from-violet-500 to-purple-600',
      ...
      { min: 0, max: 0, k: 'acts', emoji: '🛠️', title: 'Atitudes', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 0, max: 0, k: 'gifts', emoji: '🎁', title: 'Mimos', color: 'from-rose-400 to-pink-600',
