...
export const TESTS_FR: Test[] = [
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🕯️', title: 'Recharge profonde', color: 'from-slate-500 to-slate-700',
      ...
      { min: 13, max: 14, emoji: '🌙', title: 'Réserve tranquille', color: 'from-indigo-500 to-violet-600',
      ...
      { min: 15, max: 17, emoji: '🌤️', title: 'Charge équilibrée', color: 'from-sky-500 to-blue-600',
      ...
      { min: 18, max: 30, emoji: '⚡', title: 'Alimenté par les autres', color: 'from-amber-400 to-orange-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🫧', title: 'Absorbe tout', color: 'from-blue-500 to-indigo-700',
      ...
      { min: 13, max: 14, emoji: '🌧️', title: 'Encaisse lentement', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 17, emoji: '⛅', title: 'Stable sous charge', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '🗿', title: 'Calme dans la tempête', color: 'from-slate-600 to-slate-800',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🔍', title: 'Celui qui délibère', color: 'from-slate-500 to-slate-700',
      ...
      { min: 13, max: 14, emoji: '⚖️', title: 'Celui qui pèse', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 15, max: 17, emoji: '🎯', title: 'Celui qui tranche', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '⚡', title: 'L’instinctif', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 12, emoji: '🎯', title: 'Travail en profondeur', color: 'from-indigo-500 to-violet-700',
      ...
      { min: 13, max: 14, emoji: '📋', title: 'Planification régulière', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 17, emoji: '🔄', title: 'Souple et mobile', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 18, max: 30, emoji: '🔥', title: 'Performant sous pression', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: 'Ton partenaire a passé une journée horrible. Tu :', opts: [
        { text: 'Lui dis exactement ce que j’apprécie chez lui', score: 0, k: 'words' },
        { text: 'M’assois à côté sans dire grand-chose', score: 1, k: 'time' },
        { text: 'Lui enlève discrètement quelque chose des épaules', score: 2, k: 'acts' },
        { text: 'Rapporte quelque chose qu’il aime', score: 3, k: 'gifts' }] },
      { q: 'Qu’est-ce qui te fait le plus te sentir aimé ?', opts: [
        { text: 'Qu’on me le dise à voix haute', score: 0, k: 'words' }, { text: 'Du temps ensemble sans partage', score: 1, k: 'time' },
        { text: 'Que quelqu’un règle une chose pour moi', score: 2, k: 'acts' }, { text: 'Un objet choisi avec attention', score: 3, k: 'gifts' }] },
      { q: 'Ton réflexe pour un anniversaire :', opts: [
        { text: 'Écrire quelque chose', score: 0, k: 'words' }, { text: 'Prévoir une journée entière ensemble', score: 1, k: 'time' },
        { text: 'Faire une chose pratique qui manquait', score: 2, k: 'acts' }, { text: 'Trouver le bon cadeau', score: 3, k: 'gifts' }] },
      { q: 'Qu’est-ce qui fait le plus mal dans une relation ?', opts: [
        { text: 'Ne jamais entendre que ça va bien', score: 0, k: 'words' }, { text: 'Être là physiquement mais distrait', score: 1, k: 'time' },
        { text: 'Devoir tout porter seul', score: 2, k: 'acts' }, { text: 'Être oublié le jour qui comptait', score: 3, k: 'gifts' }] },
      { q: 'Un ami traverse quelque chose de difficile :', opts: [
        { text: 'Je lui dis ce que je pense de lui', score: 0, k: 'words' }, { text: 'Je lui libère une soirée', score: 1, k: 'time' },
        { text: 'Je règle un truc pratique', score: 2, k: 'acts' }, { text: 'Je lui envoie quelque chose', score: 3, k: 'gifts' }] },
      { q: 'Tu montres que quelqu’un t’a manqué en :', opts: [
        { text: 'Le disant directement', score: 0, k: 'words' }, { text: 'Dégageant du temps tout de suite', score: 1, k: 'time' },
        { text: 'Faisant quelque chose pour cette personne', score: 2, k: 'acts' }, { text: 'Rapportant quelque chose', score: 3, k: 'gifts' }] },
      { q: 'Le compliment qui te touche le plus :', opts: [
        { text: 'Quelque chose de précis sur qui je suis', score: 0, k: 'words' }, { text: '« Je veux toujours plus de temps avec toi »', score: 1, k: 'time' },
        { text: '« Tu t’occupes toujours de tout »', score: 2, k: 'acts' }, { text: '« J’ai vu ça et j’ai pensé à toi »', score: 3, k: 'gifts' }] },
      { q: 'Dans une dispute, qu’est-ce qui répare le plus vite ?', opts: [
        { text: 'Entendre ce qu’il apprécie encore chez moi', score: 0, k: 'words' }, { text: 'S’asseoir et en parler vraiment', score: 1, k: 'time' },
        { text: 'Qu’il fasse quelque chose qui le montre', score: 2, k: 'acts' }, { text: 'Un geste qui dit qu’il y a pensé', score: 3, k: 'gifts' }] },
      { q: 'Ton partenaire part un mois. Tu :', opts: [
        { text: 'Envoies de longs messages', score: 0, k: 'words' }, { text: 'Planifies des appels sans jamais manquer', score: 1, k: 'time' },
        { text: 'T’occupes de tout à la maison pour qu’il n’ait pas à s’inquiéter', score: 2, k: 'acts' }, { text: 'Lui envoies des choses par la poste', score: 3, k: 'gifts' }] },
      { q: 'Qu’est-ce qui te manquerait en premier ?', opts: [
        { text: 'Qu’on me dise ce qu’on ressent', score: 0, k: 'words' }, { text: 'Du vrai temps ensemble', score: 1, k: 'time' },
        { text: 'Être aidé sans avoir à demander', score: 2, k: 'acts' }, { text: 'Les petites surprises pensées', score: 3, k: 'gifts' }] },
    ],
    results: [
      { min: 0, max: 0, k: 'words', emoji: '💬', title: 'Les mots', color: 'from-sky-500 to-blue-600',
      ...
      { min: 0, max: 0, k: 'time', emoji: '⏳', title: 'Le temps', color: 'from-violet-500 to-purple-600',
      ...
      { min: 0, max: 0, k: 'acts', emoji: '🛠️', title: 'Les actes', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 0, max: 0, k: 'gifts', emoji: '🎁', title: 'Les attentions', color: 'from-rose-400 to-pink-600',
