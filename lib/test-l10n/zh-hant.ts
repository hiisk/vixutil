...
export const TESTS_ZH_HANT: Test[] = [
  ...
  },
  {
    ...
    results: [
      ...
      { min: 8, max: 14, emoji: '⚖️', title: '權衡型', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: '直覺型', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      ...
      { min: 8, max: 14, emoji: '📋', title: '穩健的規劃者', color: 'from-sky-500 to-blue-600',
        desc: '你會規劃、會分配節奏，說什麼時候好就什麼時候好。這份可靠比多數人以為的更值錢。只要偶爾確認一下：計畫還在為工作服務，而不是反過來。',
        traits: ['可靠', '有條理', '節奏穩', '前後一致'] },
      { min: 15, max: 21, emoji: '🔄', title: '靈活機動型', color: 'from-emerald-500 to-teal-600',
        desc: '你成波地做事，切換輕鬆，對冒出來的事隨時接得住。這很適合節奏快的工作。要留神的是：不停切換會讓人覺得很有產出，同時又讓真正難啃的問題更難收尾。',
        traits: ['適應力強', '反應快', '善協作', '俐落'] },
      { min: 22, max: 30, emoji: '🔥', title: '壓線爆發型', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: '伴侶今天過得很糟。你會：', opts: [
        { text: '把我欣賞他的地方具體說出來', score: 0 },
        { text: '坐在旁邊，不多說什麼', score: 1 },
        { text: '不聲不響地替他擋掉一件事', score: 2 },
        { text: '帶一樣他喜歡的東西回來', score: 3 }] },
      { q: '什麼最讓你覺得被在乎？', opts: [
        { text: '有人把話說出口', score: 0 }, { text: '不被打擾的相處時間', score: 1 },
        { text: '有人替我把事情辦了', score: 2 }, { text: '一件用心挑的東西', score: 3 }] },
      { q: '紀念日你的第一反應是：', opts: [
        { text: '寫點什麼', score: 0 }, { text: '規劃一整天在一起', score: 1 },
        { text: '把他一直需要的實事辦掉', score: 2 }, { text: '找到那件對的禮物', score: 3 }] },
      { q: '一段關係裡最傷人的是什麼？', opts: [
        { text: '從來聽不到一句「我們挺好的」', score: 0 }, { text: '人在旁邊，心不在', score: 1 },
        { text: '什麼都丟給我一個人扛', score: 2 }, { text: '在最要緊的那天被忘掉', score: 3 }] },
      { q: '朋友正在經歷難事：', opts: [
        { text: '我把我對他的看法講給他聽', score: 0 }, { text: '我空出一個晚上給他', score: 1 },
        { text: '我替他把一件實事辦了', score: 2 }, { text: '我寄點東西給他', score: 3 }] },
      { q: '你表達「我想你了」的方式是：', opts: [
        { text: '直接說出來', score: 0 }, { text: '馬上騰出時間', score: 1 },
        { text: '替對方做點什麼', score: 2 }, { text: '帶點東西回來', score: 3 }] },
      { q: '最能打動你的稱讚是：', opts: [
        { text: '關於我是個什麼樣的人，具體的那種', score: 0 }, { text: '「我總想跟你多待一會兒」', score: 1 },
        { text: '「你總是把事情都照顧好」', score: 2 }, { text: '「我看到這個就想到你」', score: 3 }] },
      { q: '吵架之後，什麼最快能修好？', opts: [
        { text: '聽到他仍然看重我什麼', score: 0 }, { text: '坐下來好好談一次', score: 1 },
        { text: '他做點什麼把心意做出來', score: 2 }, { text: '一個說明他想過這事的舉動', score: 3 }] },
      { q: '伴侶要離開一個月。你會：', opts: [
        { text: '傳很長的訊息', score: 0 }, { text: '雷打不動地約好通話', score: 1 },
        { text: '把家裡全扛下來，讓他不用操心', score: 2 }, { text: '寄東西給他', score: 3 }] },
      { q: '哪一樣不見了你會最先發現？', opts: [
        { text: '有人把感受說給我聽', score: 0 }, { text: '真正在一起的時間', score: 1 },
        { text: '不用開口就有人搭把手', score: 2 }, { text: '那些小小的、用心的驚喜', score: 3 }] },
    ],
    results: [
      { min: 0, max: 7, emoji: '💬', title: '言語', color: 'from-sky-500 to-blue-600',
      ...
      { min: 8, max: 14, emoji: '⏳', title: '時間', color: 'from-violet-500 to-purple-600',
        desc: '對你來說，注意力才是硬通貨。一個人真的在場、手機收起來，比他買得起或說得出的任何東西都重。反過來說：人在身邊卻心不在焉，在你這裡等同於缺席——與其憋著記恨，不如把這句話講出來。',
        traits: ['在場', '專注', '有耐心', '重視連結'] },
      { min: 15, max: 21, emoji: '🛠️', title: '行動', color: 'from-emerald-500 to-teal-600',
