...
export const TESTS_ZH_HANS: Test[] = [
  ...
  },
  {
    ...
    questions: [
      { q: '伴侣今天过得很糟。你会：', opts: [
        { text: '把我欣赏他的地方具体说出来', score: 0 },
        { text: '坐在旁边，不多说什么', score: 1 },
        { text: '不声不响地替他挡掉一件事', score: 2 },
        { text: '带一样他喜欢的东西回来', score: 3 }] },
      { q: '什么最让你觉得被在乎？', opts: [
        { text: '有人把话说出口', score: 0 }, { text: '不被打扰的相处时间', score: 1 },
        { text: '有人替我把事情办了', score: 2 }, { text: '一件用心挑的东西', score: 3 }] },
      { q: '纪念日你的第一反应是：', opts: [
        { text: '写点什么', score: 0 }, { text: '计划一整天在一起', score: 1 },
        { text: '把他一直需要的实事办掉', score: 2 }, { text: '找到那件对的礼物', score: 3 }] },
      { q: '一段关系里最伤人的是什么？', opts: [
        { text: '从来听不到一句"我们挺好的"', score: 0 }, { text: '人在旁边，心不在', score: 1 },
        { text: '什么都丢给我一个人扛', score: 2 }, { text: '在最要紧的那天被忘掉', score: 3 }] },
      { q: '朋友正在经历难事：', opts: [
        { text: '我把我对他的看法讲给他听', score: 0 }, { text: '我空出一个晚上给他', score: 1 },
        { text: '我替他把一件实事办了', score: 2 }, { text: '我给他寄点东西', score: 3 }] },
      { q: '你表达"我想你了"的方式是：', opts: [
        { text: '直接说出来', score: 0 }, { text: '马上腾出时间', score: 1 },
        { text: '替对方做点什么', score: 2 }, { text: '带点东西回来', score: 3 }] },
      { q: '最能打动你的夸奖是：', opts: [
        { text: '关于我是个什么样的人，具体的那种', score: 0 }, { text: '"我总想和你多待一会儿"', score: 1 },
        { text: '"你总是把事情都照顾好"', score: 2 }, { text: '"我看到这个就想到你"', score: 3 }] },
      { q: '吵架之后，什么最快能修好？', opts: [
        { text: '听到他仍然看重我什么', score: 0 }, { text: '坐下来好好谈一次', score: 1 },
        { text: '他做点什么把心意做出来', score: 2 }, { text: '一个说明他想过这事的举动', score: 3 }] },
      { q: '伴侣要离开一个月。你会：', opts: [
        { text: '发很长的消息', score: 0 }, { text: '雷打不动地约好通话', score: 1 },
        { text: '把家里全扛下来，让他不用操心', score: 2 }, { text: '给他寄东西', score: 3 }] },
      { q: '哪一样不见了你会最先发现？', opts: [
        { text: '有人把感受说给我听', score: 0 }, { text: '真正在一起的时间', score: 1 },
        { text: '不用开口就有人搭把手', score: 2 }, { text: '那些小小的、用心的惊喜', score: 3 }] },
    ],
    results: [
      { min: 0, max: 7, emoji: '💬', title: '言语', color: 'from-sky-500 to-blue-600',
