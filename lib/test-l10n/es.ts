 ...
 * 스페인어 심리테스트.
 *
 * 영어판 다섯 종을 옮긴 것이다. 한국어 228종은 회사 문화·연애 관습처럼 한국
...
export const TESTS_ES: Test[] = [
  {
    ...
    results: [
      ...
      { min: 8, max: 14, emoji: '🌙', title: 'Reserva tranquila', color: 'from-indigo-500 to-violet-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'Te enciende la gente', color: 'from-amber-400 to-orange-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🫧', title: 'Lo absorbes todo', color: 'from-blue-500 to-indigo-700',
      ...
      { min: 8, max: 14, emoji: '🌧️', title: 'Aguantas despacio', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '⛅', title: 'Firme bajo carga', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🗿', title: 'Calma en la tormenta', color: 'from-slate-600 to-slate-800',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🔍', title: 'El que delibera', color: 'from-slate-500 to-slate-700',
      ...
      { min: 8, max: 14, emoji: '⚖️', title: 'El que sopesa', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 15, max: 21, emoji: '🎯', title: 'El que decide', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'El instintivo', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🎯', title: 'Trabajo profundo', color: 'from-indigo-500 to-violet-700',
      ...
      { min: 8, max: 14, emoji: '📋', title: 'Planificador constante', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '🔄', title: 'Ágil y flexible', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🔥', title: 'Rinde bajo presión', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: 'Tu pareja ha tenido un día horrible. Tú:', opts: [
        { text: 'Le digo exactamente lo que valoro de ella', score: 0 },
        { text: 'Me siento a su lado sin decir mucho', score: 1 },
        { text: 'Le quito algo de encima sin avisar', score: 2 },
        { text: 'Le traigo algo que le gusta', score: 3 }] },
      { q: '¿Qué te hace sentir más cuidado?', opts: [
        { text: 'Que me lo digan en voz alta', score: 0 }, { text: 'Tiempo juntos sin distracciones', score: 1 },
        { text: 'Que alguien me resuelva algo', score: 2 }, { text: 'Un detalle bien pensado', score: 3 }] },
      { q: 'Tu instinto en un aniversario:', opts: [
        { text: 'Escribir algo', score: 0 }, { text: 'Planear un día entero juntos', score: 1 },
        { text: 'Hacer algo práctico que le hacía falta', score: 2 }, { text: 'Encontrar el regalo adecuado', score: 3 }] },
      { q: '¿Qué es lo que más duele en una relación?', opts: [
        { text: 'No oír nunca que las cosas van bien', score: 0 }, { text: 'Que esté delante pero a otra cosa', score: 1 },
        { text: 'Que me dejen todo a mí', score: 2 }, { text: 'Que se olviden del día que importaba', score: 3 }] },
      { q: 'Un amigo está pasando por algo duro:', opts: [
        { text: 'Le digo lo que pienso de él', score: 0 }, { text: 'Le dejo una tarde libre', score: 1 },
        { text: 'Le resuelvo algo práctico', score: 2 }, { text: 'Le mando algo', score: 3 }] },
      { q: 'Demuestras que has echado de menos a alguien:', opts: [
        { text: 'Diciéndoselo directamente', score: 0 }, { text: 'Haciendo hueco enseguida', score: 1 },
        { text: 'Haciendo algo por esa persona', score: 2 }, { text: 'Trayéndole algo', score: 3 }] },
      { q: 'El cumplido que más te llega:', opts: [
        { text: 'Algo concreto sobre cómo soy', score: 0 }, { text: '«Siempre quiero más tiempo contigo»', score: 1 },
        { text: '«Siempre te ocupas de todo»', score: 2 }, { text: '«Vi esto y me acordé de ti»', score: 3 }] },
      { q: 'En una discusión, ¿qué la arregla antes?', opts: [
        { text: 'Oír qué sigue valorando de mí', score: 0 }, { text: 'Sentarnos a hablarlo en serio', score: 1 },
        { text: 'Que haga algo que lo demuestre', score: 2 }, { text: 'Un gesto que diga que lo ha pensado', score: 3 }] },
      { q: 'Tu pareja se va un mes. Tú:', opts: [
        { text: 'Mando mensajes largos', score: 0 }, { text: 'Programo llamadas sin fallar', score: 1 },
        { text: 'Me ocupo de todo en casa para que no se preocupe', score: 2 }, { text: 'Le envío cosas por correo', score: 3 }] },
      { q: '¿Qué echarías en falta primero?', opts: [
        { text: 'Que me digan lo que siente', score: 0 }, { text: 'Tiempo de verdad juntos', score: 1 },
        { text: 'Que me echen una mano sin pedirlo', score: 2 }, { text: 'Las sorpresas pequeñas y pensadas', score: 3 }] },
    ],
    results: [
      { min: 0, max: 7, emoji: '💬', title: 'Palabras', color: 'from-sky-500 to-blue-600',
      ...
      { min: 8, max: 14, emoji: '⏳', title: 'Tiempo', color: 'from-violet-500 to-purple-600',
      ...
      { min: 15, max: 21, emoji: '🛠️', title: 'Hechos', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🎁', title: 'Detalles', color: 'from-rose-400 to-pink-600',
