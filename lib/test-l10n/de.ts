...
export const TESTS_DE: Test[] = [
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🕯️', title: 'Lädt in der Tiefe', color: 'from-slate-500 to-slate-700',
      ...
      { min: 8, max: 14, emoji: '🌙', title: 'Stille Reserve', color: 'from-indigo-500 to-violet-600',
      ...
      { min: 15, max: 21, emoji: '🌤️', title: 'Ausgeglichene Ladung', color: 'from-sky-500 to-blue-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'Läuft auf Menschen', color: 'from-amber-400 to-orange-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🫧', title: 'Nimmt alles auf', color: 'from-blue-500 to-indigo-700',
      ...
      { min: 8, max: 14, emoji: '🌧️', title: 'Steht es langsam durch', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '⛅', title: 'Stabil unter Last', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🗿', title: 'Ruhe im Sturm', color: 'from-slate-600 to-slate-800',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🔍', title: 'Die abwägende Art', color: 'from-slate-500 to-slate-700',
      ...
      { min: 8, max: 14, emoji: '⚖️', title: 'Die abwiegende Art', color: 'from-sky-500 to-indigo-600',
      ...
      { min: 15, max: 21, emoji: '🎯', title: 'Die entscheidende Art', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '⚡', title: 'Die instinktive Art', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    results: [
      { min: 0, max: 7, emoji: '🎯', title: 'Tiefarbeiterin oder Tiefarbeiter', color: 'from-indigo-500 to-violet-700',
      ...
      { min: 8, max: 14, emoji: '📋', title: 'Verlässliche Planung', color: 'from-sky-500 to-blue-600',
      ...
      { min: 15, max: 21, emoji: '🔄', title: 'Bewegliche Arbeitsweise', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🔥', title: 'Läuft unter Druck', color: 'from-amber-400 to-rose-500',
  ...
  },
  {
    ...
    questions: [
      { q: 'Dein Gegenüber hatte einen furchtbaren Tag. Du:', opts: [
        { text: 'Sage genau, was ich an ihr oder ihm schätze', score: 0 },
        { text: 'Setze mich dazu, ohne viel zu sagen', score: 1 },
        { text: 'Nehme ihr oder ihm still etwas ab', score: 2 },
        { text: 'Bringe etwas mit, das sie oder er mag', score: 3 }] },
      { q: 'Wobei fühlst du dich am meisten umsorgt?', opts: [
        { text: 'Wenn es laut ausgesprochen wird', score: 0 }, { text: 'Ungeteilte gemeinsame Zeit', score: 1 },
        { text: 'Wenn mir jemand etwas abnimmt', score: 2 }, { text: 'Ein durchdachter Gegenstand', score: 3 }] },
      { q: 'Dein Instinkt an einem Jahrestag:', opts: [
        { text: 'Etwas schreiben', score: 0 }, { text: 'Einen ganzen Tag zusammen planen', score: 1 },
        { text: 'Etwas Praktisches erledigen, das gefehlt hat', score: 2 }, { text: 'Das richtige Geschenk finden', score: 3 }] },
      { q: 'Was tut in einer Beziehung am meisten weh?', opts: [
        { text: 'Nie zu hören, dass es gut läuft', score: 0 }, { text: 'Körperlich da, aber abgelenkt', score: 1 },
        { text: 'Alles allein stemmen zu müssen', score: 2 }, { text: 'An dem Tag vergessen zu werden, der zählte', score: 3 }] },
      { q: 'Eine Freundin oder ein Freund macht Schweres durch:', opts: [
        { text: 'Ich sage, was ich von ihr oder ihm halte', score: 0 }, { text: 'Ich mache einen Abend frei', score: 1 },
        { text: 'Ich regle etwas Praktisches', score: 2 }, { text: 'Ich schicke etwas', score: 3 }] },
      { q: 'Du zeigst, dass du jemanden vermisst hast, indem du:', opts: [
        { text: 'Es direkt sagst', score: 0 }, { text: 'Sofort Zeit frei machst', score: 1 },
        { text: 'Etwas für die Person tust', score: 2 }, { text: 'Etwas mitbringst', score: 3 }] },
      { q: 'Das Kompliment, das am tiefsten trifft:', opts: [
        { text: 'Etwas Konkretes darüber, wer ich bin', score: 0 }, { text: '„Ich will immer mehr Zeit mit dir“', score: 1 },
        { text: '„Du kümmerst dich immer um alles“', score: 2 }, { text: '„Ich habe das gesehen und an dich gedacht“', score: 3 }] },
      { q: 'Was repariert einen Streit am schnellsten?', opts: [
        { text: 'Zu hören, was die Person weiter an mir schätzt', score: 0 }, { text: 'Sich richtig zusammenzusetzen und zu reden', score: 1 },
        { text: 'Dass sie etwas tut, das es zeigt', score: 2 }, { text: 'Eine Geste, die sagt, dass sie darüber nachgedacht hat', score: 3 }] },
      { q: 'Dein Gegenüber ist einen Monat weg. Du:', opts: [
        { text: 'Schickst lange Nachrichten', score: 0 }, { text: 'Planst Anrufe eisern ein', score: 1 },
        { text: 'Regelst zu Hause alles, damit sie oder er sich nicht sorgen muss', score: 2 }, { text: 'Schickst Dinge mit der Post', score: 3 }] },
      { q: 'Was würdest du zuerst vermissen?', opts: [
        { text: 'Zu hören, wie die Person fühlt', score: 0 }, { text: 'Echte gemeinsame Zeit', score: 1 },
        { text: 'Hilfe zu bekommen, ohne zu fragen', score: 2 }, { text: 'Kleine durchdachte Überraschungen', score: 3 }] },
    ],
    results: [
      { min: 0, max: 7, emoji: '💬', title: 'Worte', color: 'from-sky-500 to-blue-600',
      ...
      { min: 8, max: 14, emoji: '⏳', title: 'Zeit', color: 'from-violet-500 to-purple-600',
      ...
      { min: 15, max: 21, emoji: '🛠️', title: 'Taten', color: 'from-emerald-500 to-teal-600',
      ...
      { min: 22, max: 30, emoji: '🎁', title: 'Zeichen', color: 'from-rose-400 to-pink-600',
