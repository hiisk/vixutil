/**
 * 렌즈 화각 104가지 — 초점거리와 센서 규격만 적는다.
 *
 * 화각도, 35mm 환산 초점거리도, 두 발짝 앞에서 담기는 폭도 전부 두 숫자에서
 * 나온다. 표를 손으로 적으면 104 × 다섯 칸이고, 한 칸이 틀려도 그럴듯한
 * 숫자라 아무도 못 잡는다.
 *
...
/**
 * 실제로 파는 초점거리들 — 스물여섯 가지.
 *
 * 25mm를 빼면 마이크로포서드의 표준 렌즈가 사라진다. 판마다 즐겨 쓰는 값이
 * 다르므로 어느 판에서든 표준이 되는 초점거리는 모두 넣는다.
 */
export const FOCALS = [
  8, 10, 12, 14, 16, 18, 20, 24, 25, 28, 35, 40, 50, 60, 70, 85,
  100, 105, 135, 150, 200, 300, 400, 500, 600, 800,
];
