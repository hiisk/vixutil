/**
 * 공예 120종 — 분류별 파일을 모아 하나의 카탈로그로 낸다.
 *
...
import { CROCHET_TOOLS } from './craft/crochet.ts';
import { SEW_TOOLS } from './craft/sew.ts';
import { SEW2_TOOLS } from './craft/sew2.ts';
import { SEW3_TOOLS } from './craft/sew3.ts';
...
export const CRAFT_TOOLS: FormulaTool[] = [
  ...KNIT_TOOLS, ...KNIT2_TOOLS, ...CROCHET_TOOLS,
  ...SEW_TOOLS, ...SEW2_TOOLS, ...SEW3_TOOLS,
