...
export const HANJA_L10N: Partial<Record<IntlLocale, Record<string, IdiomText>>> = {
 ...
 */
export const GLOSS_L10N: Partial<Record<IntlLocale, Record<string, [string, string, string, string]>>> = {
