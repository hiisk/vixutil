...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'snap/face-thirds': () => newSnapCard('zh-hant', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('zh-hant', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('zh-hant', 'face-shape'),
  'snap/brows': () => newSnapCard('zh-hant', 'brows'),
  'snap/lips': () => newSnapCard('zh-hant', 'lips'),
  'snap/contrast': () => newSnapCard('zh-hant', 'contrast'),
  'snap/backdrop': () => newSnapCard('zh-hant', 'backdrop'),
  ...
  'bed': () => bedHub('tw'),
  'blood': () => bloodHub('tw'),
  'exposure': () => exposureHub('tw'),
  'heredity': () => heredityHub('tw'),
  'raid': () => raidHub('tw'),
  'flight': () => flightHub('tw'),
  'purifier': () => purifierHub('tw'),
  'drink': () => drinkHub('tw'),
  'bra': () => braHub('tw'),
  ...
  'motor': () => motorHub('tw'),
  'steel': () => steelHub('tw'),
  'hardness': () => hardnessHub('tw'),
  'dpi': () => dpiHub('tw'),
  'sun': () => sunHub('tw'),
  'laundry': () => laundryHub('tw'),
  'fertilizer': () => fertilizerHub('tw'),
  'filament': () => filamentHub('tw'),
  'bpm': () => bpmHub('tw'),
  'uv': () => uvHub('tw'),
  'hike': () => hikeHub('tw'),
  'insul': () => insulHub('tw'),
  ...
  'fret': () => fretHub('tw'),
  'game': () => intlOg('game/ja'),
  'game/sliding': () => gameOg('sliding', 'zh-hant'),
  'game/sudoku': () => gameOg('sudoku', 'zh-hant'),
  'game/minesweeper': () => gameOg('minesweeper', 'zh-hant'),
  'game/2048': () => gameOg('2048', 'zh-hant'),
  ...
  'game/stroop': () => gameOg('stroop', 'zh-hant'),
  'game/dot-count': () => gameOg('dot-count', 'zh-hant'),
  'game/nback': () => gameOg('nback', 'zh-hant'),
  'game/rotation': () => gameOg('rotation', 'zh-hant'),
  'game/beat': () => gameOg('beat', 'zh-hant'),
  'game/peripheral': () => gameOg('peripheral', 'zh-hant'),
  'generator': () => intlOg('generator/zh-hant'),
  'craft': () => {
    const meta = sectionMeta(CRAFT_SECTION, 'zh-hant');
    return ogCard({
      icon: '🧶',
      eyebrow: meta.section,
      title: meta.hubTitle,
  ...
  'image/watermark': () => imageOg('watermark', 'zh-hant'),
  'image/adjust': () => imageOg('adjust', 'zh-hant'),
  'image/frame': () => imageOg('frame', 'zh-hant'),
  'image/round': () => imageOg('round', 'zh-hant'),
  'image/split': () => imageOg('split', 'zh-hant'),
  'image/favicon': () => imageOg('favicon', 'zh-hant'),
  'image/size': () => imgsizeHub('tw'),
  'keycode': () => keycodeHub('tw'),
  'lumen': () => lumenHub('tw'),
  'microwave': () => microwaveHub('tw'),
  'metro': () => metroHub('tw'),
  'music': () => musicHub('tw'),
  'number': () => numberHub('tw'),
  'pace': () => paceHub('tw'),
  ...
  'text/mask': () => textOg('mask', 'zh-hant'),
  'text/wrap': () => textOg('wrap', 'zh-hant'),
  'text/table': () => textOg('table', 'zh-hant'),
  'text/slug': () => textOg('slug', 'zh-hant'),
  'text/reverse': () => textOg('reverse', 'zh-hant'),
  'text/qr': () => textOg('qr', 'zh-hant'),
  'text/vertical': () => textOg('vertical', 'zh-hant'),
