...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'motor': () => motorHub('pt'),
  'steel': () => steelHub('pt'),
  'hardness': () => hardnessHub('pt'),
  'dpi': () => dpiHub('pt'),
  'sun': () => sunHub('pt'),
  'laundry': () => laundryHub('pt'),
  'fertilizer': () => fertilizerHub('pt'),
  ...
  'game/sliding': () => gameOg('sliding', 'pt-br'),
  'game/sudoku': () => gameOg('sudoku', 'pt-br'),
  'game/minesweeper': () => gameOg('minesweeper', 'pt-br'),
  'game/2048': () => gameOg('2048', 'pt-br'),
