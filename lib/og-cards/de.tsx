...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'bed': () => bedHub('de'),
  'blood': () => bloodHub('de'),
  'exposure': () => exposureHub('de'),
  'heredity': () => heredityHub('de'),
  'raid': () => raidHub('de'),
  'flight': () => flightHub('de'),
  'purifier': () => purifierHub('de'),
  'drink': () => drinkHub('de'),
  'bra': () => braHub('de'),
  ...
  'gengo': () => gengoHub('de'),
  'golf': () => golfHub('de'),
  'viewing': () => viewingHub('de'),
  'wine': () => wineHub('de'),
  'petfood': () => petfoodHub('de'),
  'size': () => sizeHub('de'),
  'dof': () => dofHub('de'),
  'gear': () => gearHub('de'),
  'ring': () => ringHub('de'),
  ...
  'motor': () => motorHub('de'),
  'steel': () => steelHub('de'),
  'hardness': () => hardnessHub('de'),
  'dpi': () => dpiHub('de'),
  'sun': () => sunHub('de'),
  'laundry': () => laundryHub('de'),
  'fertilizer': () => fertilizerHub('de'),
  'filament': () => filamentHub('de'),
  'bpm': () => bpmHub('de'),
  'uv': () => uvHub('de'),
  'hike': () => hikeHub('de'),
  'insul': () => insulHub('de'),
  ...
  'lumen': () => lumenHub('de'),
  'microwave': () => microwaveHub('de'),
  'metro': () => metroHub('de'),
  'music': () => musicHub('de'),
  'number': () => numberHub('de'),
  'pace': () => paceHub('de'),
  'paper': () => paperHub('de'),
  'powerbank': () => powerbankHub('de'),
  'quake': () => quakeHub('de'),
  'port': () => portHub('de'),
  'quiz': () => intlOg('quiz/de'),
