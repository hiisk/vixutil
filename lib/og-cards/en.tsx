...
export const CARDS: Record<string, () => ReactElement> = {
  'snap/lighting': () => newSnapCard('en', 'lighting'),
  'snap/sharpness': () => newSnapCard('en', 'sharpness'),
  'snap/face-thirds': () => newSnapCard('en', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('en', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('en', 'face-shape'),
  'snap/brows': () => newSnapCard('en', 'brows'),
  'snap/lips': () => newSnapCard('en', 'lips'),
  'snap/contrast': () => newSnapCard('en', 'contrast'),
  'snap/backdrop': () => newSnapCard('en', 'backdrop'),
  'snap/white-balance': () => newSnapCard('en', 'white-balance'),
  'snap/distance': () => newSnapCard('en', 'distance'),
  'snap/mirror': () => newSnapCard('en', 'mirror'),
  'snap/id-photo': () => newSnapCard('en', 'id-photo'),
  'snap/head-pose': () => newSnapCard('en', 'head-pose'),
  'snap/real-smile': () => newSnapCard('en', 'real-smile'),
  ...
  'bed': () => bedHub('en'),
  'blood': () => bloodHub('en'),
  'exposure': () => exposureHub('en'),
  'heredity': () => heredityHub('en'),
  'raid': () => raidHub('en'),
  'flight': () => flightHub('en'),
  'purifier': () => purifierHub('en'),
  'drink': () => drinkHub('en'),
  'bra': () => braHub('en'),
  ...
  'fret': () => fretHub('en'),
  'game': () => intlOg('game/en'),
  'game/sliding': () => gameOg('sliding', 'en'),
  'game/sudoku': () => gameOg('sudoku', 'en'),
  'game/minesweeper': () => gameOg('minesweeper', 'en'),
  'game/2048': () => gameOg('2048', 'en'),
  ...
  'game/stroop': () => gameOg('stroop', 'en'),
  'game/dot-count': () => gameOg('dot-count', 'en'),
  'game/nback': () => gameOg('nback', 'en'),
  'game/rotation': () => gameOg('rotation', 'en'),
  'game/beat': () => gameOg('beat', 'en'),
  'game/peripheral': () => gameOg('peripheral', 'en'),
  'generator': () => intlOg('generator/en'),
  'craft': () => {
    const meta = CRAFT_SECTION.meta['en'];
    return ogCard({
      icon: '🧶',
      eyebrow: meta.section,
      title: meta.hubTitle,
  ...
  'image/watermark': () => imageOg('watermark', 'en'),
  'image/adjust': () => imageOg('adjust', 'en'),
  'image/frame': () => imageOg('frame', 'en'),
  'image/round': () => imageOg('round', 'en'),
  'image/split': () => imageOg('split', 'en'),
  'image/favicon': () => imageOg('favicon', 'en'),
  'image/size': () => imgsizeHub('en'),
  'keycode': () => keycodeHub('en'),
  'lumen': () => lumenHub('en'),
  'microwave': () => microwaveHub('en'),
  'metro': () => metroHub('en'),
  'music': () => musicHub('en'),
  'number': () => numberHub('en'),
  'pace': () => paceHub('en'),
  'paper': () => paperHub('en'),
  'powerbank': () => powerbankHub('en'),
  'quake': () => quakeHub('en'),
  'port': () => portHub('en'),
  'quiz': () => intlOg('quiz/en'),
  ...
  'text/mask': () => textOg('mask', 'en'),
  'text/wrap': () => textOg('wrap', 'en'),
  'text/table': () => textOg('table', 'en'),
  'text/slug': () => textOg('slug', 'en'),
  'text/reverse': () => textOg('reverse', 'en'),
  'text/qr': () => textOg('qr', 'en'),
  'text/vertical': () => textOg('vertical', 'en'),
