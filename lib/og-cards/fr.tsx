...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'snap/face-thirds': () => newSnapCard('fr', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('fr', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('fr', 'face-shape'),
  'snap/brows': () => newSnapCard('fr', 'brows'),
  'snap/lips': () => newSnapCard('fr', 'lips'),
  'snap/contrast': () => newSnapCard('fr', 'contrast'),
  'snap/backdrop': () => newSnapCard('fr', 'backdrop'),
  ...
  'bed': () => bedHub('fr'),
  'blood': () => bloodHub('fr'),
  'exposure': () => exposureHub('fr'),
  'heredity': () => heredityHub('fr'),
  'raid': () => raidHub('fr'),
  'flight': () => flightHub('fr'),
  'purifier': () => purifierHub('fr'),
  'drink': () => drinkHub('fr'),
  'bra': () => braHub('fr'),
  ...
  'motor': () => motorHub('fr'),
  'steel': () => steelHub('fr'),
  'hardness': () => hardnessHub('fr'),
  'dpi': () => dpiHub('fr'),
  'sun': () => sunHub('fr'),
  'laundry': () => laundryHub('fr'),
  'fertilizer': () => fertilizerHub('fr'),
  'filament': () => filamentHub('fr'),
  'bpm': () => bpmHub('fr'),
  'uv': () => uvHub('fr'),
  'hike': () => hikeHub('fr'),
  'insul': () => insulHub('fr'),
  ...
  'fret': () => fretHub('fr'),
  'game': () => intlOg('game/fr'),
  'game/sliding': () => gameOg('sliding', 'fr'),
  'game/sudoku': () => gameOg('sudoku', 'fr'),
  'game/minesweeper': () => gameOg('minesweeper', 'fr'),
  'game/2048': () => gameOg('2048', 'fr'),
  ...
  'craft': () => {
    const meta = sectionMeta(CRAFT_SECTION, 'fr');
    return ogCard({
      icon: '🧶',
      eyebrow: meta.section,
      title: meta.hubTitle,
  ...
  'image/watermark': () => imageOg('watermark', 'fr'),
  'image/adjust': () => imageOg('adjust', 'fr'),
  'image/frame': () => imageOg('frame', 'fr'),
  'image/round': () => imageOg('round', 'fr'),
  'image/split': () => imageOg('split', 'fr'),
  'image/favicon': () => imageOg('favicon', 'fr'),
  ...
  'text/mask': () => textOg('mask', 'fr'),
  'text/wrap': () => textOg('wrap', 'fr'),
  'text/table': () => textOg('table', 'fr'),
  'text/slug': () => textOg('slug', 'fr'),
  'text/reverse': () => textOg('reverse', 'fr'),
  'text/qr': () => textOg('qr', 'fr'),
  'text/vertical': () => textOg('vertical', 'fr'),
