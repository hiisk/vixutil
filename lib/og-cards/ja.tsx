...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'snap/face-thirds': () => newSnapCard('ja', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('ja', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('ja', 'face-shape'),
  'snap/brows': () => newSnapCard('ja', 'brows'),
  'snap/lips': () => newSnapCard('ja', 'lips'),
  'snap/contrast': () => newSnapCard('ja', 'contrast'),
  'snap/backdrop': () => newSnapCard('ja', 'backdrop'),
  ...
  'bed': () => bedHub('ja'),
  'blood': () => bloodHub('ja'),
  'exposure': () => exposureHub('ja'),
  'heredity': () => heredityHub('ja'),
  'raid': () => raidHub('ja'),
  'flight': () => flightHub('ja'),
  'purifier': () => purifierHub('ja'),
  'drink': () => drinkHub('ja'),
  'bra': () => braHub('ja'),
  ...
  'gengo': () => gengoHub('ja'),
  'golf': () => golfHub('ja'),
  'viewing': () => viewingHub('ja'),
  'wine': () => wineHub('ja'),
  'petfood': () => petfoodHub('ja'),
  'size': () => sizeHub('ja'),
  'dof': () => dofHub('ja'),
  'gear': () => gearHub('ja'),
  'ring': () => ringHub('ja'),
  ...
  'motor': () => motorHub('ja'),
  'steel': () => steelHub('ja'),
  'hardness': () => hardnessHub('ja'),
  'dpi': () => dpiHub('ja'),
  'sun': () => sunHub('ja'),
  'laundry': () => laundryHub('ja'),
  'fertilizer': () => fertilizerHub('ja'),
  'filament': () => filamentHub('ja'),
  'bpm': () => bpmHub('ja'),
  'uv': () => uvHub('ja'),
  'hike': () => hikeHub('ja'),
  'insul': () => insulHub('ja'),
  ...
  'fret': () => fretHub('ja'),
  'game': () => intlOg('game/ja'),
  'game/sliding': () => gameOg('sliding', 'ja'),
  'game/sudoku': () => gameOg('sudoku', 'ja'),
  'game/minesweeper': () => gameOg('minesweeper', 'ja'),
  'game/2048': () => gameOg('2048', 'ja'),
  ...
  'game/stroop': () => gameOg('stroop', 'ja'),
  'game/dot-count': () => gameOg('dot-count', 'ja'),
  'game/nback': () => gameOg('nback', 'ja'),
  'game/rotation': () => gameOg('rotation', 'ja'),
  ...
  'image/watermark': () => imageOg('watermark', 'ja'),
  'image/adjust': () => imageOg('adjust', 'ja'),
  'image/frame': () => imageOg('frame', 'ja'),
  'image/round': () => imageOg('round', 'ja'),
  'image/split': () => imageOg('split', 'ja'),
  'image/favicon': () => imageOg('favicon', 'ja'),
  'image/size': () => imgsizeHub('ja'),
  'keycode': () => keycodeHub('ja'),
  'lumen': () => lumenHub('ja'),
  'microwave': () => microwaveHub('ja'),
  'metro': () => metroHub('ja'),
  'music': () => musicHub('ja'),
  'number': () => numberHub('ja'),
  'pace': () => paceHub('ja'),
  'paper': () => paperHub('ja'),
  'powerbank': () => powerbankHub('ja'),
  'quake': () => quakeHub('ja'),
  'port': () => portHub('ja'),
  'quiz': () => intlOg('quiz/ja'),
  ...
  'text/mask': () => textOg('mask', 'ja'),
  'text/wrap': () => textOg('wrap', 'ja'),
  'text/table': () => textOg('table', 'ja'),
  'text/slug': () => textOg('slug', 'ja'),
  'text/reverse': () => textOg('reverse', 'ja'),
  'text/qr': () => textOg('qr', 'ja'),
  'text/vertical': () => textOg('vertical', 'ja'),
