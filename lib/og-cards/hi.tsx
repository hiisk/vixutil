...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'snap/face-thirds': () => newSnapCard('hi', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('hi', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('hi', 'face-shape'),
  'snap/brows': () => newSnapCard('hi', 'brows'),
  'snap/lips': () => newSnapCard('hi', 'lips'),
  'snap/contrast': () => newSnapCard('hi', 'contrast'),
  'snap/backdrop': () => newSnapCard('hi', 'backdrop'),
  ...
  'bed': () => bedHub('hi'),
  'blood': () => bloodHub('hi'),
  'exposure': () => exposureHub('hi'),
  'heredity': () => heredityHub('hi'),
  'raid': () => raidHub('hi'),
  'flight': () => flightHub('hi'),
  'purifier': () => purifierHub('hi'),
  'drink': () => drinkHub('hi'),
  'bra': () => braHub('hi'),
  ...
  'motor': () => motorHub('hi'),
  'steel': () => steelHub('hi'),
  'hardness': () => hardnessHub('hi'),
  'dpi': () => dpiHub('hi'),
  'sun': () => sunHub('hi'),
  'laundry': () => laundryHub('hi'),
  'fertilizer': () => fertilizerHub('hi'),
  'filament': () => filamentHub('hi'),
  'bpm': () => bpmHub('hi'),
  'uv': () => uvHub('hi'),
  'hike': () => hikeHub('hi'),
  'insul': () => insulHub('hi'),
  ...
  'fret': () => fretHub('hi'),
  'game': () => intlOg('game/hi'),
  'game/sliding': () => gameOg('sliding', 'hi'),
  'game/sudoku': () => gameOg('sudoku', 'hi'),
  'game/minesweeper': () => gameOg('minesweeper', 'hi'),
  'game/2048': () => gameOg('2048', 'hi'),
  ...
  'game/stroop': () => gameOg('stroop', 'hi'),
  'game/dot-count': () => gameOg('dot-count', 'hi'),
  'game/nback': () => gameOg('nback', 'hi'),
  'game/rotation': () => gameOg('rotation', 'hi'),
  'game/beat': () => gameOg('beat', 'hi'),
  'game/peripheral': () => gameOg('peripheral', 'hi'),
  'generator': () => intlOg('generator/hi'),
  'craft': () => {
    const meta = sectionMeta(CRAFT_SECTION, 'hi');
    return ogCard({
      icon: '🧶',
      eyebrow: meta.section,
      title: meta.hubTitle,
  ...
  'image/watermark': () => imageOg('watermark', 'hi'),
  'image/adjust': () => imageOg('adjust', 'hi'),
  'image/frame': () => imageOg('frame', 'hi'),
  'image/round': () => imageOg('round', 'hi'),
  'image/split': () => imageOg('split', 'hi'),
  'image/favicon': () => imageOg('favicon', 'hi'),
  'image/size': () => imgsizeHub('hi'),
  'keycode': () => keycodeHub('hi'),
  'lumen': () => lumenHub('hi'),
  'microwave': () => microwaveHub('hi'),
  'metro': () => metroHub('hi'),
  'music': () => musicHub('hi'),
  'number': () => numberHub('hi'),
  'pace': () => paceHub('hi'),
  'paper': () => paperHub('hi'),
  'powerbank': () => powerbankHub('hi'),
  'quake': () => quakeHub('hi'),
  'port': () => portHub('hi'),
  'quiz': () => intlOg('quiz/hi'),
  ...
  'text/mask': () => textOg('mask', 'hi'),
  'text/wrap': () => textOg('wrap', 'hi'),
  'text/table': () => textOg('table', 'hi'),
  'text/slug': () => textOg('slug', 'hi'),
  'text/reverse': () => textOg('reverse', 'hi'),
  'text/qr': () => textOg('qr', 'hi'),
  'text/vertical': () => textOg('vertical', 'hi'),
