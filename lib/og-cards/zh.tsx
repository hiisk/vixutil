...
export const CARDS: Record<string, () => ReactElement> = {
  ...
  'snap/face-thirds': () => newSnapCard('zh-hans', 'face-thirds'),
  'snap/eye-spacing': () => newSnapCard('zh-hans', 'eye-spacing'),
  'snap/face-shape': () => newSnapCard('zh-hans', 'face-shape'),
  'snap/brows': () => newSnapCard('zh-hans', 'brows'),
  'snap/lips': () => newSnapCard('zh-hans', 'lips'),
  'snap/contrast': () => newSnapCard('zh-hans', 'contrast'),
  'snap/backdrop': () => newSnapCard('zh-hans', 'backdrop'),
  ...
  'motor': () => motorHub('zh'),
  'steel': () => steelHub('zh'),
  'hardness': () => hardnessHub('zh'),
  'dpi': () => dpiHub('zh'),
  'sun': () => sunHub('zh'),
  'laundry': () => laundryHub('zh'),
  'fertilizer': () => fertilizerHub('zh'),
  'filament': () => filamentHub('zh'),
  'bpm': () => bpmHub('zh'),
  'uv': () => uvHub('zh'),
  'hike': () => hikeHub('zh'),
  'insul': () => insulHub('zh'),
  ...
  'fret': () => fretHub('zh'),
  'game': () => intlOg('game/ja'),
  'game/sliding': () => gameOg('sliding', 'zh-hans'),
  'game/sudoku': () => gameOg('sudoku', 'zh-hans'),
  'game/minesweeper': () => gameOg('minesweeper', 'zh-hans'),
  'game/2048': () => gameOg('2048', 'zh-hans'),
  ...
  'game/stroop': () => gameOg('stroop', 'zh-hans'),
  'game/dot-count': () => gameOg('dot-count', 'zh-hans'),
  'game/nback': () => gameOg('nback', 'zh-hans'),
  'game/rotation': () => gameOg('rotation', 'zh-hans'),
  'game/beat': () => gameOg('beat', 'zh-hans'),
  'game/peripheral': () => gameOg('peripheral', 'zh-hans'),
  'generator': () => intlOg('generator/zh-hans'),
  'craft': () => {
    const meta = sectionMeta(CRAFT_SECTION, 'zh-hans');
    return ogCard({
      icon: '🧶',
      eyebrow: meta.section,
      title: meta.hubTitle,
  ...
  'image/watermark': () => imageOg('watermark', 'zh-hans'),
  'image/adjust': () => imageOg('adjust', 'zh-hans'),
  'image/frame': () => imageOg('frame', 'zh-hans'),
  'image/round': () => imageOg('round', 'zh-hans'),
  'image/split': () => imageOg('split', 'zh-hans'),
  'image/favicon': () => imageOg('favicon', 'zh-hans'),
  ...
  'text/mask': () => textOg('mask', 'zh-hans'),
  'text/wrap': () => textOg('wrap', 'zh-hans'),
  'text/table': () => textOg('table', 'zh-hans'),
  'text/slug': () => textOg('slug', 'zh-hans'),
  'text/reverse': () => textOg('reverse', 'zh-hans'),
  'text/qr': () => textOg('qr', 'zh-hans'),
  'text/vertical': () => textOg('vertical', 'zh-hans'),
