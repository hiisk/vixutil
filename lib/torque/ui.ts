...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '조임 토크 228칸 — M8 8.8은 26N·m',
    '228 torque figures — M8 in grade 8.8 takes 26 N·m',
    '228 pares de apriete — un M8 de grado 8.8 pide 26 N·m',
    '228 torques de aperto — um M8 classe 8.8 pede 26 N·m',
    '締め付けトルク152マス — M8の8.8は26N·m',
    '228 Anzugsmomente — M8 in 8.8 braucht 26 N·m',
    '228 couples de serrage — un M8 en 8.8 demande 26 N·m',
    '152 टॉर्क मान — 8.8 ग्रेड का M8 यानी 26 N·m',
    '228 个拧紧扭矩 — 8.8 级 M8 需要 26N·m',
    '228 個鎖緊扭矩 — 8.8 級 M8 需要 26N·m',
  ),

  hubLead: T(
    '볼트 19가지와 등급 12가지가 만나는 칸마다 목표 축력과 조임 토크를 계산했습니다. 표를 옮겨 적은 것이 아니라, 등급 숫자에서 강도를 읽고 나사 단면적을 곱해 낸 값입니다.',
    'A target clamp force and a tightening torque for every meeting of 19 bolt sizes and 12 grades. Nothing is copied from a table: the grade number gives the strength, the thread gives the area, and the rest follows.',
    'Una fuerza de apriete objetivo y un par para cada cruce de 19 diámetros y 12 grados. Nada se copia de una tabla: el número de grado da la resistencia, la rosca da la sección y el resto sale solo.',
    'Uma força de aperto alvo e um torque para cada cruzamento de 19 diâmetros e 12 classes. Nada é copiado de tabela: o número da classe dá a resistência, a rosca dá a área, e o resto sai daí.',
    'ボルト19通りと等級8通りが出会う各マスの目標軸力と締め付けトルクを計算しました。表を写したのではなく、等級の数字から強度を読み、ねじの断面積を掛けて出した値です。',
    'Für jede Begegnung von 19 Schraubengrößen und 12 Festigkeitsklassen eine Zielvorspannkraft und ein Anzugsmoment. Nichts ist abgeschrieben: die Klasse liefert die Festigkeit, das Gewinde die Fläche, der Rest folgt.',
    'Une précharge visée et un couple pour chaque croisement de 19 diamètres et 12 classes. Rien n’est recopié d’un tableau : la classe donne la résistance, le filetage la section, et le reste suit.',
    ...
    '19 种螺栓与 12 个强度等级交汇的每一格都算出目标预紧力和拧紧扭矩。没有照抄表格：等级数字给出强度，螺纹给出截面积，其余顺势而来。',
    '19 種螺栓與 12 個強度等級交匯的每一格都算出目標預緊力和鎖緊扭矩。沒有照抄表格：等級數字給出強度，螺紋給出截面積，其餘順勢而來。',
  ),
  ...
  hubMetaTitle: T(
    '볼트 조임 토크표 — M3부터 M36까지, 등급 12가지',
    'Bolt torque chart — M3 to M36 across 12 grades',
    'Tabla de pares de apriete — de M3 a M36 en 12 grados',
    'Tabela de torque — de M3 a M36 em 12 classes',
    'ボルト締め付けトルク表 — M3からM36、等級12種',
    'Anzugsmoment-Tabelle — M3 bis M36 in 12 Klassen',
    'Tableau des couples de serrage — M3 à M36, 12 classes',
    'बोल्ट टॉर्क चार्ट — M3 से M36, 8 ग्रेड',
    '螺栓拧紧扭矩表 — M3 到 M36，12 个等级',
    '螺栓鎖緊扭矩表 — M3 到 M36，12 個等級',
  ),

  hubMetaDesc: T(
    'M8 8.8은 건조 기준 26N·m, 기름을 바르면 20N·m입니다. 볼트 19가지와 등급 12가지가 만나는 228칸마다 목표 축력과 조임 토크를 계산했습니다.',
    'An M8 in grade 8.8 takes 26 N·m dry, 20 N·m oiled. Target clamp force and tightening torque for all 228 pairings of 19 bolt sizes and 12 grades.',
    'Un M8 de grado 8.8 pide 26 N·m en seco y 20 N·m engrasado. Fuerza objetivo y par para los 228 cruces de 19 diámetros y 12 grados.',
    'Um M8 classe 8.8 pede 26 N·m a seco e 20 N·m lubrificado. Força alvo e torque para os 228 cruzamentos de 19 diâmetros e 12 classes.',
    'M8の8.8は乾燥で26N·m、油を差すと20N·mです。ボルト19通りと等級8通りが出会う152マスの目標軸力と締め付けトルクを計算しました。',
    'Ein M8 in 8.8 braucht trocken 26 N·m, geölt 20 N·m. Zielvorspannkraft und Anzugsmoment für alle 228 Kombinationen aus 19 Größen und 12 Klassen.',
    'Un M8 en 8.8 demande 26 N·m à sec, 20 N·m huilé. Précharge visée et couple pour les 228 croisements de 19 diamètres et 12 classes.',
    '8.8 ग्रेड का M8 सूखे में 26 N·m और तेल लगे पर 20 N·m लेता है। 19 आकार और 8 ग्रेड के सभी 152 मेलों का लक्ष्य बल और टॉर्क।',
    '8.8 级 M8 干态需 26N·m，上油后 20N·m。19 种螺栓与 12 个等级交汇的 152 格，每格的目标预紧力与拧紧扭矩。',
    '8.8 級 M8 乾態需 26N·m，上油後 20N·m。19 種螺栓與 12 個等級交匯的 152 格，每格的目標預緊力與鎖緊扭矩。',
  ),
