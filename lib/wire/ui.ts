...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '전선 345칸 — AWG 12로 15A를 몇 미터까지',
    '345 wire runs — how far AWG 12 carries 15 A',
    '345 tramos de cable — hasta dónde lleva 15 A un AWG 12',
    '345 trechos de fio — até onde um AWG 12 leva 15 A',
    '電線200マス — AWG 12で15Aを何メートルまで',
    '345 Leitungen — wie weit AWG 12 15 A trägt',
    '345 tronçons de câble — jusqu’où un AWG 12 porte 15 A',
  ...
  hubLead: T(
    '굵기 23가지와 전류 15가지가 만나는 칸마다 저항과 전압 강하, 3% 안에 드는 길이를 계산했습니다. AWG 번호는 외울 표가 아니라 지름이 계산되는 수열입니다.',
    'For every meeting of 23 gauges and 15 currents: the resistance, the voltage drop, and how far you can run before losing 3%. AWG numbers are not a table to memorise but a sequence whose diameter is calculated.',
    'Para cada cruce de 23 calibres y 15 corrientes: la resistencia, la caída de tensión y hasta dónde llega antes de perder el 3%. Los números AWG no son una tabla que memorizar sino una sucesión cuyo diámetro se calcula.',
    'Para cada cruzamento de 23 bitolas e 15 correntes: a resistência, a queda de tensão e até onde vai antes de perder 3%. Os números AWG não são uma tabela a decorar, mas uma sequência cujo diâmetro se calcula.',
    '太さ20通りと電流10通りが出会う各マスの抵抗、電圧降下、3%以内で届く長さを計算しました。AWG番号は覚える表ではなく、直径が計算で出る数列です。',
    'Für jede Begegnung von 23 Querschnitten und 15 Strömen: Widerstand, Spannungsfall und wie weit es reicht, bevor 3 % verloren gehen. AWG-Nummern sind keine Tabelle zum Auswendiglernen, sondern eine Folge, deren Durchmesser sich berechnet.',
    'Pour chaque croisement de 23 sections et 15 courants : la résistance, la chute de tension et la distance atteinte avant de perdre 3 %. Les numéros AWG ne sont pas un tableau à retenir mais une suite dont le diamètre se calcule.',
    ...
    '23 种线径与 15 种电流交汇的每一格都算出电阻、压降，以及在 3% 之内能走多远。AWG 编号不是要背的表，而是可以算出直径的数列。',
    '23 種線徑與 15 種電流交匯的每一格都算出電阻、壓降，以及在 3% 之內能走多遠。AWG 編號不是要背的表，而是可以算出直徑的數列。',
  ),
  ...
  hubMetaTitle: T(
    '전선 굵기 계산 — AWG·mm² 23가지 × 전류 15가지',
    'Wire gauge calculator — 23 sizes in AWG and mm² across 15 currents',
    'Calculadora de calibre — 23 tamaños en AWG y mm² con 15 corrientes',
    'Calculadora de bitola — 23 tamanhos em AWG e mm² com 15 correntes',
    '電線の太さ計算 — AWG・mm² 20通り×電流10通り',
    'Querschnitt berechnen — 23 Größen in AWG und mm², 15 Ströme',
    'Calcul de section — 23 tailles en AWG et mm², 15 courants',
    'तार मोटाई कैलकुलेटर — AWG और mm² में 23 आकार, 10 धाराएँ',
    '导线线径计算 — AWG 与 mm² 共 23 种 × 15 种电流',
    '導線線徑計算 — AWG 與 mm² 共 23 種 × 15 種電流',
  ),

  hubMetaDesc: T(
    'AWG 12로 15A를 보내면 10미터에 1.56V가 사라집니다. 굵기와 전류가 만나는 345칸마다 저항·강하·발열과 12V부터 230V까지 3% 안에 드는 길이를 계산했습니다.',
    'AWG 12 carrying 15 A loses 1.56 V over ten metres. For all 345 pairings of gauge and current: resistance, drop, heat, and how far you can run at 12 V through 230 V while staying under 3%.',
    'Un AWG 12 con 15 A pierde 1,56 V en diez metros. Para los 345 cruces de calibre y corriente: resistencia, caída, calor y hasta dónde llega de 12 V a 230 V sin pasar del 3%.',
    'Um AWG 12 com 15 A perde 1,56 V em dez metros. Para os 345 cruzamentos de bitola e corrente: resistência, queda, calor e até onde vai de 12 V a 230 V sem passar de 3%.',
    'AWG 12で15Aを流すと10メートルで1.56Vが失われます。太さと電流が出会う200マスごとの抵抗・降下・発熱と、12Vから230Vまで3%以内で届く長さを計算しました。',
    'AWG 12 mit 15 A verliert auf zehn Metern 1,56 V. Für alle 345 Kombinationen aus Querschnitt und Strom: Widerstand, Abfall, Wärme und die Reichweite von 12 V bis 230 V unter 3 %.',
    'Un AWG 12 parcouru par 15 A perd 1,56 V sur dix mètres. Pour les 345 croisements section × courant : résistance, chute, chaleur et portée de 12 V à 230 V en restant sous 3 %.',
