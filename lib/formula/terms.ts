...
export const TERMS: Record<string, Term> = { ...CORE_TERMS, ...RATE_TERMS, ...BODY_TERMS, ...BODY2_TERMS, ...GEO_TERMS, ...GEO2_TERMS, ...GEO3_TERMS, ...RATE2_TERMS, ...BODY3_TERMS, ...CRAFT_TERMS, ...CRAFT2_TERMS, ...CRAFT3_TERMS, ...CRAFT4_TERMS, ...GEO4_TERMS, ...RATE3_TERMS };
export const UNITS: Record<string, Term> = { ...CORE_UNITS, ...RATE_UNITS, ...BODY_UNITS, ...BODY2_UNITS, ...GEO_UNITS, ...GEO2_UNITS, ...CRAFT_UNITS, ...CRAFT2_UNITS, ...CRAFT3_UNITS, ...CRAFT4_UNITS, ...GEO4_UNITS, ...RATE3_UNITS };
