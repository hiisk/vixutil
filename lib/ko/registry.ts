...
export const KO_LEAVES: Record<string, () => Promise<KoLeaf>> = {
  ...
  'fertilizer': () => import('./pages/fertilizer__slug'),
  ...
  'motor': () => import('./pages/motor__slug'),
