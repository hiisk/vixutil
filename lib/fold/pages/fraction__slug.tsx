...
/* 생성됨: scripts가 아니라 접기 이행 — 원본은 옛 app/(zh-hant)/zh-hant/fraction/[slug]/page.tsx.
...
export function build(lang: FoldLang) {
  ...
  async function Page({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return <FractionPage slug={slug} lang={DATA_KEY[lang]} />;
  }
   ...
   */
  const generateStaticParams = () => fractionParams();
