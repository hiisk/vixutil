...
const SPEC: Spec = {
  ...
  hubTitle: T(
    '충전 300칸 — 5000mAh를 20W로 채우면 62분',
    '300 charge times — 5000 mAh at 20 W takes 62 minutes',
    '300 tiempos de carga — 5000 mAh a 20 W tarda 62 minutos',
    '300 tempos de carga — 5000 mAh a 20 W leva 62 minutos',
    '充電200マス — 5000mAhを20Wで62分',
    '300 Ladezeiten — 5000 mAh mit 20 W in 62 Minuten',
    '300 temps de charge — 5000 mAh à 20 W en 62 minutes',
    '200 चार्ज समय — 20 W पर 5000 mAh में 62 मिनट',
    '300 个充电时间 — 20W 给 5000mAh 充满需 62 分钟',
    '300 個充電時間 — 20W 給 5000mAh 充滿需 62 分鐘',
  ),

  hubLead: T(
    '배터리 용량 20가지와 충전기 15가지가 만나는 칸마다 채우는 시간을 계산했습니다. mAh는 전압을 곱해야 에너지가 되고, 충전기 와트도 전압과 전류의 곱입니다.',
    'A charge time for every meeting of 20 battery sizes and 15 chargers. mAh only becomes energy once you multiply by a voltage, and a charger’s watts are a voltage times a current.',
    'Un tiempo de carga para cada cruce de 20 baterías y 15 cargadores. Los mAh solo son energía al multiplicarlos por un voltaje, y los vatios del cargador son voltaje por corriente.',
    'Um tempo de carga para cada cruzamento de 20 baterias e 15 carregadores. Os mAh só viram energia ao multiplicar por uma tensão, e os watts do carregador são tensão vezes corrente.',
    'バッテリー容量20通りと充電器10通りが出会う各マスの充電時間を計算しました。mAhは電圧を掛けて初めてエネルギーになり、充電器のワットも電圧と電流の積です。',
    'Eine Ladezeit für jede Begegnung von 20 Akkugrößen und 15 Netzteilen. mAh werden erst mit einer Spannung zu Energie, und die Watt eines Netzteils sind Spannung mal Strom.',
    'Un temps de charge pour chaque croisement de 20 batteries et 15 chargeurs. Les mAh ne deviennent de l’énergie qu’en les multipliant par une tension, et les watts d’un chargeur sont une tension fois un courant.',
    ...
    '20 种电池容量与 15 种充电器交汇的每一格都算出充电时间。mAh 要乘以电压才是能量，充电器的瓦数也是电压乘电流。',
    '20 種電池容量與 15 種充電器交匯的每一格都算出充電時間。mAh 要乘以電壓才是能量，充電器的瓦數也是電壓乘電流。',
  ),
  ...
  hubMetaTitle: T(
    '배터리 충전 시간 — 용량 20가지 × 충전기 15가지',
    'Battery charging time — 20 capacities across 15 chargers',
    'Tiempo de carga de batería — 20 capacidades y 15 cargadores',
    'Tempo de carga de bateria — 20 capacidades e 15 carregadores',
    'バッテリー充電時間 — 容量20通り×充電器10通り',
    'Akku-Ladezeit — 20 Kapazitäten und 15 Netzteile',
    'Temps de charge — 20 capacités et 15 chargeurs',
    'बैटरी चार्ज समय — 20 क्षमताएँ और 10 चार्जर',
    '电池充电时间 — 20 种容量 × 15 种充电器',
    '電池充電時間 — 20 種容量 × 15 種充電器',
  ),

  hubMetaDesc: T(
    '5000mAh를 20W로 채우면 62분. 용량과 충전기가 만나는 300칸마다 충전 시간, 전압과 전류, 케이블에 칩이 필요한지, 기내 반입까지 계산했습니다.',
    '5000 mAh at 20 W takes 62 minutes. For all 300 pairings of battery and charger: the time, the voltage and current, whether the cable needs a chip, and what flies.',
    '5000 mAh a 20 W tarda 62 minutos. Para los 300 cruces de batería y cargador: el tiempo, voltaje y corriente, si el cable necesita chip y qué puede volar.',
    '5000 mAh a 20 W leva 62 minutos. Para os 300 cruzamentos de bateria e carregador: o tempo, tensão e corrente, se o cabo precisa de chip e o que pode voar.',
    '5000mAhを20Wで62分。容量と充電器が出会う200マスごとの充電時間、電圧と電流、ケーブルにチップが要るか、機内持ち込みまで計算しました。',
    '5000 mAh mit 20 W in 62 Minuten. Für alle 300 Kombinationen aus Akku und Netzteil: Zeit, Spannung und Strom, ob das Kabel einen Chip braucht und was ins Flugzeug darf.',
    '5000 mAh à 20 W en 62 minutes. Pour les 300 croisements batterie × chargeur : le temps, la tension et le courant, si le câble doit avoir une puce, et ce qui peut voler.',
