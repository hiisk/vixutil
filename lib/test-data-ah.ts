...
export const TESTS_AH: Test[] = [
  {
    ...
    results: [
      ...
      { min: 28, max: 40, title: '카페인 프리 청정러 💧',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '회식을 즐기는 분위기 메이커 🎤',
      ...
      { min: 23, max: 24, title: '무난하게 어울리는 타입 🍽️',
        ...
        traits: ['적응', '균형', '무던함', '조율'] },
      { min: 25, max: 27, title: '빨리 집에 가고 싶은 타입 🏠',
      ...
      { min: 28, max: 40, title: '회식이 곤혹스러운 타입 🌧️',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '헬스장이 맞는 타입 🏋️',
      ...
      { min: 23, max: 24, title: '둘 다 되는 균형형 🤸',
      ...
      { min: 28, max: 40, title: '일단 움직이는 것부터 🌱',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '배달과 거리를 둔 타입 🥗',
      ...
      { min: 28, max: 40, title: '점검이 필요한 타입 🚨',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '구독을 다스리는 사람 🧾',
      ...
      { min: 28, max: 40, title: '전면 점검이 필요한 타입 🚨',
  ...
  },
  {
    ...
    results: [
      ...
      { min: 28, max: 40, title: '아직 먼 이야기인 타입 🏙️',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '타고난 첫째 스타일 🎓',
      ...
      { min: 28, max: 40, title: '혼자가 익숙한 외동 스타일 🌙',
  ...
  },
  {
    ...
    results: [
      ...
      { min: 25, max: 27, title: '차분한 관찰형 🌙',
        ...
        traits: ['신중', '경청', '차분함', '깊이'] },
      { min: 28, max: 40, title: '속을 잘 안 드러내는 타입 🫥',
  ...
  },
  {
    ...
    results: [
      ...
      { min: 28, max: 40, title: '내용을 모르는 상태 ❓',
  ...
  },
  {
    ...
    results: [
      { min: 10, max: 22, title: '정상을 향하는 등반가 ⛰️',
