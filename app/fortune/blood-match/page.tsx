    ...
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="max-w-xl mx-auto px-4 py-6">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-black text-slate-900 dark:text-slate-100">🩸 혈액형 궁합</h1>
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5 mb-4 flex flex-col gap-5">
          ...
          <button
            onClick={calculate}
            disabled={!me || !partner}
            className="w-full rounded-xl bg-gradient-to-r from-rose-500 to-red-600 disabled:from-slate-200 disabled:to-slate-200 dark:disabled:from-slate-800 dark:disabled:to-slate-800 disabled:text-slate-400 text-white text-sm font-black py-3.5 transition-all active:scale-[0.99] shadow-md shadow-rose-200 disabled:shadow-none"
          >
