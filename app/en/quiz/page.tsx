...
export const metadata: Metadata = {
  title: 'Free Quizzes — Geography, Science, History & Tech',
...
export default function EnQuizHub() {
  return (
    <div className="relative min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl font-black text-slate-900 dark:text-slate-100 mb-2">Free Quizzes</h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">Ten questions each, four choices, every answer explained.</p>
      ...
      <footer className="border-t border-slate-100 dark:border-slate-800 py-8 text-center">
        ...
        <p className="text-xs text-slate-400 mt-1">Free online quizzes</p>
      </footer>
    </div>
  );
}
