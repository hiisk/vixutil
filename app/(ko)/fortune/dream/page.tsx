      ...
      <header className="bg-white/90 dark:bg-slate-900/90 backdrop-blur border-b border-slate-100 dark:border-slate-800 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <span className="ml-auto shrink-0">
            <LangPicker current="ko" route="/fortune/dream" available={ALL_LOCALES10} />
          </span>
        </div>
      </header>
            ...
            {filtered.map(dream => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1.5">{dream.keyword}</div>
              ...
              <div className="flex items-start gap-4 py-5 border-b border-slate-100 dark:border-slate-800">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">{selected.keyword} 꿈</h2>
