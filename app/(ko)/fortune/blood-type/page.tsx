...
export default function BloodTypePage() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <span className="ml-auto shrink-0">
            <LangPicker current="ko" route="/fortune/blood-type" available={ALL_LOCALES10} />
          </span>
        </div>
      </header>
      ...
      <RelatedContent items={FORTUNE_RELATED} currentSlug="blood-type" basePath="/fortune" accent="violet" bg="" />
