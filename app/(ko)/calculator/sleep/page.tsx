  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
          ...
          {times.map(t => (
            <div key={t.cycles} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">{t.cycles}사이클 · {t.hours}시간</p>
              </div>
        ...
        <Card className="p-4">
          <p className="text-xs text-slate-500 dark:text-slate-400">수면 사이클 90분 기준 · 사람마다 차이가 있을 수 있습니다</p>
        </Card>
      </div>
    </CalcShell>
  );
