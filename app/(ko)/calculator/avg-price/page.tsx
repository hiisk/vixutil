      ...
      <div className="flex flex-col gap-4">
        <Card>
              ...
              <div key={i} className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className={i === 0 ? 'pt-6' : ''}>
                  <button onClick={() => setRows(prev => prev.filter((_, idx) => idx !== i))}
                    className="w-full py-3 text-slate-500 dark:text-slate-400 hover:text-red-400 text-sm font-bold transition-colors">
                    ✕
                  </button>
                </div>
              </div>
          ...
          <div className="px-4 pb-4">
            <Label>현재가 <span className="dial-opt">손익 계산용, 선택</span></Label>
