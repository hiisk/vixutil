  ...
  return (
    ...
    >
      <div className="flex justify-end mb-4">
        <LangPicker current="ko" route="/calculator/retirement" available={ALL_LOCALES10} />
      </div>
        ...
        {result && (
          <>
            ...
            <div className="rounded-lg border border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-950/30 p-5">
              ...
              <p className="text-4xl font-bold text-blue-700 dark:text-blue-300">{fmtKRW(result.totalAsset)}</p>
                  ...
                  <tbody>
                    {result.rows.slice(0, showing).map(r => (
                      <tr key={r.year} className="border-b border-slate-50">
                        ...
                        <td className="py-2 text-blue-700 dark:text-blue-300 font-bold">{fmtKRW(r.endBalance)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
