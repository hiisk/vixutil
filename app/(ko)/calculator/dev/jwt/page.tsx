    ...
    <CalcShell path="/calculator/dev/jwt" title="JWT Decoder" description="JWT 토큰 파싱 및 Payload 확인" wide>
      <div className="flex flex-col gap-4">
        ...
        {result && (
          <>
            {isExpired !== null && (
              <div className={`rounded-xl p-3 text-sm font-semibold ${isExpired ? 'bg-red-50 dark:bg-red-950/30 text-red-700' : 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-300'}`}>
