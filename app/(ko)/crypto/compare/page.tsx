    ...
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="hero-band max-w-3xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="page-h1">Compare two coins</h1>
        ...
        */}
        <section className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-900/50 p-5 mb-4 note-sm [&>p]:max-w-[72ch]">
          <h2 className="text-base font-bold text-slate-900 dark:text-white mb-3">Bitcoin vs Ethereum, and every other pairing</h2>
          <p className="mb-3">
