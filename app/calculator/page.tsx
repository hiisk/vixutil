        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="h-14 flex items-center gap-4">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <Link href="/calculator/en" className="text-xs font-semibold text-slate-400 hover:text-slate-700 px-2 py-1 rounded-full hover:bg-slate-50 transition-colors">EN</Link>
              <Link href="/calculator/ja" className="text-xs font-semibold text-slate-400 hover:text-slate-700 px-2 py-1 rounded-full hover:bg-slate-50 transition-colors">JA</Link>
            </div>
          </div>
        </div>
      </header>
