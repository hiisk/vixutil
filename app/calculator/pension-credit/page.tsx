    ...
    <CalcShell
      ...
      intro={
        <>
          <h2>납입 한도</h2>
          <p>
            연금저축만 넣으면 <strong>연 600만원</strong>까지, 여기에 IRP를 더하면{' '}
            <strong>합산 연 900만원</strong>까지 세액공제를 받습니다. 연금저축 없이 IRP만으로 900만원을
            채우는 것도 됩니다. 한도를 넘겨 넣은 금액은 공제 대상이 아닙니다.
          </p>
          <h2>공제율은 소득으로 갈립니다</h2>
          <p>
            총급여 <strong>5,500만원 이하</strong>(근로자가 아니면 종합소득금액 4,500만원 이하)면{' '}
            <strong>16.5%</strong>, 그보다 많으면 <strong>13.2%</strong>가 적용됩니다.
            소득세 15%·12%에 지방소득세를 더한 값입니다. 900만원을 꽉 채우면 각각 148.5만원과
            118.8만원을 돌려받는 셈입니다.
          </p>
          <h2>세액공제는 공짜가 아닙니다</h2>
          <p>
            지금 돌려받는 대신 나중에 연금으로 꺼낼 때 <strong>연금소득세</strong>를 냅니다. 세율이 더 낮아서
            이득인 구조이지, 세금이 사라지는 것이 아닙니다. 중도에 해지하면 그동안 받은 공제를 토해내는 데다{' '}
            <strong>기타소득세 16.5%</strong>가 붙으므로, 오래 묶어둘 수 있는 돈만 넣는 것이 좋습니다.
            실제 공제액은 국세청 연말정산 간소화 자료 기준으로 확정됩니다.
          </p>
        </>
      }
    >
