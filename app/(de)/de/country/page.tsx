...
const meta = countryHubMeta('de');

export const metadata: Metadata = withCard({
  title: meta.metaTitle,
  description: meta.metaDesc,
  openGraph: openGraphFor('de'),
  alternates: { canonical: localeHref('de', '/country'), languages: countryAlternates() },
});

export default function CountryHubPageDe() {
  return <CountryHub lang="de" />;
}
